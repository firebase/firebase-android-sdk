...
/**
 * Skip the currently running gradle task with the specified [reason].
 *
 * Syntax sugar for throwing a [StopExecutionException], as the naming of [StopExecutionException]
 * doesn't necessarily imply at the call-site that the task is being _skipped_ versus the build
 * being stopped itself.
 */
