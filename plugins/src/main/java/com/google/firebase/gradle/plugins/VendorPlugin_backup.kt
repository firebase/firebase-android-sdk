...
//
//class VendorPluginBackup : Plugin<Project> {
...
//}
//
//abstract class VendorTaskBackup @Inject constructor(private val execOperations: ExecOperations) :
//    DefaultTask() {
...
//}
//
//fun _inferPackages(dir: File): Set<String> {
//    return dir
//        .walk()
//        .filter { it.name.endsWith(".class") }
//        .map { it.parentFile.toRelativeString(dir).replace('/', '.').replace("\\", ".") }
//        .toSet()
//}
//
//fun _unzipJar(jar: File, directory: File) {
//    ZipFile(jar).use { zip ->
//        zip
//            .entries()
//            .asSequence()
...
//}
//
//fun _zipAll(directory: File, zipFile: File) {
//
