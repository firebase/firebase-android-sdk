...
- [deprecated] `firebase-dynamic-links` is deprecated. For information about
  timelines and alternatives, see the
  [irebase-dynamic-links deprecation FAQ](/support/dynamic-links-faq).
...
- [changed] Added Kotlin extensions (KTX) APIs from
  ...
  `com.google.firebase.dynamiclinks` package. For details, see the
...
- [feature] The beta release of a [ddls] Android library with Kotlin extensions
  ...
  `firebase-dynamic-links` library. To learn more, visit the [[ddls] KTX
...
- [changed] Refactored code to ensure functionality alignment with other updated
  Firebase libraries.
