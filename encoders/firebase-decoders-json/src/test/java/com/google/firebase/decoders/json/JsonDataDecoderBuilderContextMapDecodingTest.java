...
public class JsonDataDecoderBuilderContextMapDecodingTest {
  ...
  public void nestedMap_shouldBeDecodedCorrectly() throws IOException {
    DataDecoder decoder =
        new JsonDataDecoderBuilder().register(MapFoo.class, new MapFooObjectDecoder()).build();

    String json = "{\"map\": {\"1\": \"1\", \"2\": \"2\"}}";
    InputStream input = new ByteArrayInputStream(json.getBytes(UTF_8));
    MapFoo mapFoo = decoder.decode(input, TypeToken.of(new Safe<MapFoo>() {}));
  ...
  public void map_shouldBeDecodedCorrectly() throws IOException {
    ...
    Map<Double, String> map =
        decoder.decode(input, TypeToken.of(new Safe<HashMap<Double, String>>() {}));
  ...
  public void mapWithCustomizedObjectValue_shouldBeDecodedCorrectly() throws IOException {
    DataDecoder decoder =
        new JsonDataDecoderBuilder()
            .register(SimpleFoo.class, new SimpleFooObjectDecoder())
            .build();

    String json = "{\"1\": {\"i\":1}}";
    InputStream input = new ByteArrayInputStream(json.getBytes(UTF_8));
    Map<String, SimpleFoo> map =
        decoder.decode(input, TypeToken.of(new Safe<HashMap<String, SimpleFoo>>() {}));
  ...
  public void mapWithCustomizedObjectKey_shouldThrowException() throws IOException {
    ...
    assertThrows(
        ...
        () -> {
          decoder.decode(input, TypeToken.of(new Safe<HashMap<SimpleFoo, String>>() {}));
        });
  }
  ...
  public void mapContainsDuplicateKeys_shouldThrowException() throws IOException {
    ...
    assertThrows(
        ...
        IllegalArgumentException.class,
        () -> {
          decoder.decode(input, TypeToken.of(new Safe<HashMap<String, String>>() {}));
        });
  }
  ...
  public void map_shouldDecodedAsHashMapClassInDefault() throws IOException {
    ...
    Map<String, String> map =
        decoder.decode(input, TypeToken.of(new Safe<Map<String, String>>() {}));
  ...
  public void sortedMap_shouldDecodedAsHashMapClassInDefault() throws IOException {
    ...
    SortedMap<String, String> map =
        decoder.decode(input, TypeToken.of(new Safe<SortedMap<String, String>>() {}));
