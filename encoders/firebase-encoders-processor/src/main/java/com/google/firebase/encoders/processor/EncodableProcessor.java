...
public class EncodableProcessor extends AbstractProcessor {
  ...
  public synchronized void init(ProcessingEnvironment processingEnvironment) {
    ...
    this.getterFactory = new GetterFactory(types, elements, processingEnvironment.getMessager());
  }
  ...
  class GetterVisitor implements TypeVisitor<Encoder> {
    ...
    public VisitResult<Encoder> visit(TypeMirror type) {
      ...
      return new VisitResult<>(result, Encoder.create(types.erasure(type), encoder));
    }
