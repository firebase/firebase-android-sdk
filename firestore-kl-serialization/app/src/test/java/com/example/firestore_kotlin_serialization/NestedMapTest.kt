...
class NestedMapTest {
    ...
    fun decodePlainMap() {
        ...
        val decodedObject = decodeFromNestedMap<PlainProject>(plainMap)
    ...
    fun decodeMapInSideOfMap() {
        ...
        val decodedObject = decodeFromNestedMap<MapInsideOfMapProject>(mapInsideOfMap)
    ...
    fun decodeListInsideOfMap() {
        ...
        val decodedObject = decodeFromNestedMap<ListInsideOfMapProject>(listInsideOfMap)
