...
LOCAL_C_INCLUDES := $(LOCAL_PATH)/$(THIRD_PARTY_PATH)/.. \
...
LOCAL_CPPFLAGS := -D_FILE_OFFSET_BITS=64 -DZLIB_CONST \
                  -DCRASHPAD_ZLIB_SOURCE_SYSTEM -DCRASHPAD_LSS_SOURCE_EXTERNAL \
                  -fno-rtti -fvisibility-inlines-hidden -std=c++17

LOCAL_SRC_FILES := $(THIRD_PARTY_PATH)/crashpad/util/file/delimited_file_reader.cc \
