...
LOCAL_CPPFLAGS := -D_FILE_OFFSET_BITS=64 -DCRASHPAD_LSS_SOURCE_EXTERNAL \
                  -fno-rtti -fvisibility-inlines-hidden -std=c++17

LOCAL_SRC_FILES := $(THIRD_PARTY_PATH)/crashpad/client/annotation.cc \
...
LOCAL_STATIC_LIBRARIES :=  crashpad_tool_support \
                           crashpad_util
