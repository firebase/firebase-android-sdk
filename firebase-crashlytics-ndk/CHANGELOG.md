...
- [changed] Updated `firebase-crashlytics` dependency to v18.0.1, which fixes a
  bug that could cause excessive disk usage from NDK crash report files when
...
- [changed] [crashlytics] NDK crash reporting will now start automatically when
  the [crashlytics] NDK dependency is included in your app.
- [changed] The [crashlytics] Gradle plugin has new tasks to support uploading
  symbol files to [crashlytics] servers. See the [[crashlytics] Gradle plugin
  documentation](/docs/crashlytics/ndk-reports-new-sdk) for more information.
