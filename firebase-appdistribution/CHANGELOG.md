...
- [fixed] Fixed failing APK downloads due to an invalid file provider authority
  [#8136]
...
- [removed] The Kotlin extensions library `firebase-appdistribution-ktx` has
  been removed. All its functionality has been moved to the new API-only
