 ...
 * a custom serializer can be passed in). The structure information of the custom @[Serializable]
 * object will be recorded inside of the serializer’s descriptor (i.e. the name/type of each
 * property to be encoded, the annotation on each property).
