...
internal object FunctionRegistry {
  val functions: Map<String, EvaluateFunction> =
    mapOf(
      ...
      "array_last" to evaluateArrayLast,
      "array_first_n" to evaluateArrayFirstN,
      "array_last_n" to evaluateArrayLastN,
      "array_minimum" to evaluateArrayMinimum,
      "array_maximum" to evaluateArrayMaximum,
      "array_minimum_n" to evaluateArrayMinimumN,
      "array_maximum_n" to evaluateArrayMaximumN,
      "array_index_of" to evaluateArrayIndexOf,
      "array_index_of_all" to evaluateArrayIndexOfAll,
      ...
      "map_set" to notImplemented,
      "map_keys" to notImplemented,
      "map_values" to notImplemented,
      "map_entries" to notImplemented,
