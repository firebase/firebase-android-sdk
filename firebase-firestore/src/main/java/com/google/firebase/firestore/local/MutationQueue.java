...
interface MutationQueue {
   ...
   * @param baseStateMutations Mutations that are used to populate the base values when this
   *     mutation is applied locally. These mutations are used to locally overwrite values that are
   *     persisted in the remote document cache.
