...
public class Blob implements Comparable<Blob> {
  ...
  private Blob(ByteString bytes, int subtype) {
    this.bytes = bytes;
  ...
  public String toString() {
    return "Blob { bytes=" + Util.toDebugString(bytes) + ", subtype=" + subtype + " }";
  }
