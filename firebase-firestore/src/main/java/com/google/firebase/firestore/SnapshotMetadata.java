...
public class SnapshotMetadata {
   ...
   *     updates (via {@code MetadataChanges.INCLUDE}) you will receive another snapshot with
   *     {@code hasPendingWrites()} equal to false once the writes have been committed to the backend.
   */
  @PublicApi
