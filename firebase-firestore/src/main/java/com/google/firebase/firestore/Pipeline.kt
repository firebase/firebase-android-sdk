...
class Pipeline internal constructor(
    ...
    internal constructor(firestore: FirebaseFirestore, stage: Stage) : this(firestore, FluentIterable.of(stage))
...
class PipelineSnapshot internal constructor(
    val executionTime: SnapshotVersion,
    val results: List<PipelineResult>
)

class PipelineResult internal constructor(
    private val key: DocumentReference?,
    val fields: Map<String, Value>,
    val version: SnapshotVersion,
)

interface PipelineResultObserver {
