 ...
 */
abstract class Expression internal constructor() : Canonicalizable {
  ...
  companion object {
     ...
     * @return A new [Expression] constant instance representing the Blob.
     */
    @JvmStatic fun blob(bytes: ByteArray): Expression = constant(Blob.fromBytes(bytes))
     ...
     * @return A new [Expression] representing the generic function.
     */
    @JvmStatic
    fun generic(name: String, vararg expr: Expression): Expression =
     ...
     */
    @JvmStatic
    fun isNan(expr: Expression): BooleanExpression =
     ...
     */
    @JvmStatic
    fun isNan(fieldName: String): BooleanExpression =
     ...
     */
    @JvmStatic
    fun isNotNan(expr: Expression): BooleanExpression =
     ...
     */
    @JvmStatic
    fun isNotNan(fieldName: String): BooleanExpression =
     ...
     */
    @JvmStatic
    fun isNull(expr: Expression): BooleanExpression =
     ...
     */
    @JvmStatic
    fun isNull(fieldName: String): BooleanExpression =
     ...
     */
    @JvmStatic
    fun isNotNull(expr: Expression): BooleanExpression =
     ...
     */
    @JvmStatic
    fun isNotNull(fieldName: String): BooleanExpression =
     ...
     * .
     * @return A new [Expression] representing the string with the first occurrence replaced.
     */
    @JvmStatic
    fun replaceFirst(
      ...
      FunctionExpression("replace_first", evaluateReplaceFirst, stringExpression, find, replace)
     ...
     */
    @JvmStatic
    fun replaceFirst(stringExpression: Expression, find: String, replace: String): Expression =
      FunctionExpression("replace_first", evaluateReplaceFirst, stringExpression, find, replace)
     ...
     */
    @JvmStatic
    fun replaceFirst(fieldName: String, find: Expression, replace: Expression): Expression =
      FunctionExpression("replace_first", evaluateReplaceFirst, fieldName, find, replace)
     ...
     */
    @JvmStatic
    fun replaceFirst(fieldName: String, find: String, replace: String): Expression =
      FunctionExpression("replace_first", evaluateReplaceFirst, fieldName, find, replace)
     ...
     * @return A new [Expression] representing the string with all occurrences replaced.
     */
    @JvmStatic
    fun replaceAll(
      stringExpression: Expression,
      ...
      FunctionExpression("replace_all", evaluateReplaceAll, stringExpression, find, replace)
     ...
     */
    @JvmStatic
    fun replaceAll(stringExpression: Expression, find: String, replace: String): Expression =
      FunctionExpression("replace_all", evaluateReplaceAll, stringExpression, find, replace)
     ...
     */
    @JvmStatic
    fun replaceAll(fieldName: String, find: Expression, replace: Expression): Expression =
      FunctionExpression("replace_all", evaluateReplaceAll, fieldName, find, replace)
     ...
     */
    @JvmStatic
    fun replaceAll(fieldName: String, find: String, replace: String): Expression =
      FunctionExpression("replace_all", evaluateReplaceAll, fieldName, find, replace)
     ...
     */
    @JvmStatic
    fun stringReverse(stringExpression: Expression): Expression =
      FunctionExpression("string_reverse", evaluateReverse, stringExpression)
    ...
    fun stringReverse(fieldName: String): Expression =
      FunctionExpression("string_reverse", evaluateReverse, fieldName)
   ...
   * @return A new [BooleanExpression] representing the isNan operation.
   */
  fun isNan(): BooleanExpression = Companion.isNan(this)
   ...
   * @return A new [BooleanExpression] representing the isNotNan operation.
   */
  fun isNotNan(): BooleanExpression = Companion.isNotNan(this)
   ...
   * @return A new [BooleanExpression] representing the isNull operation.
   */
  fun isNull(): BooleanExpression = Companion.isNull(this)
   ...
   * @return A new [BooleanExpression] representing the isNotNull operation.
   */
  fun isNotNull(): BooleanExpression = Companion.isNotNull(this)
   ...
   * @return A new [Expression] representing the string with the first occurrence replaced.
   */
  fun replaceFirst(find: Expression, replace: Expression) =
    Companion.replaceFirst(this, find, replace)
   ...
   * @return A new [Expression] representing the string with all occurrences replaced.
   */
  fun replaceAll(find: Expression, replace: Expression) = Companion.replaceAll(this, find, replace)
   ...
   * @return A new [Expression] representing the reversed string.
   */
  fun stringReverse(): Expression = Companion.stringReverse(this)
...
internal constructor(name: String, function: EvaluateFunction, params: Array<out Expression>) :
  ...
  companion object {
     ...
     * BooleanExpression.generic("my_boolean_function", field("arg1"), constant(true))
     * ```
     *
     * @param name The name of the generic function.
     * @param expr The expressions to be passed as arguments to the function.
     * @return A new [BooleanExpression] representing the generic function.
     */
    @JvmStatic
    fun generic(name: String, vararg expr: Expression): BooleanExpression =
   ...
   * @return A new [BooleanExpression] representing the ifError operation.
   */
  fun ifError(catchExpr: BooleanExpression): BooleanExpression =
 ...
 */
class Ordering internal constructor(val expr: Expression, internal val dir: Direction) :
  Canonicalizable {
  override fun canonicalId(): String {
