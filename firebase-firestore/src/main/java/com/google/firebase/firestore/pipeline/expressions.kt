...
abstract class Expression internal constructor() {
  ...
  companion object {
     ...
     * timestampTrunc(field("createdAt"), "day")
     * ```
     *
     ...
     */
    @JvmStatic
    fun timestampTrunc(timestamp: Expression, granularity: String): Expression =
     ...
     * ```kotlin
     * // Truncate the 'createdAt' timestamp to the beginning of the day.
     * timestampTrunc(field("createdAt"), field("granularity"))
     * ```
     *
     * @param timestamp The timestamp expression.
     ...
     */
    @JvmStatic
    fun timestampTrunc(timestamp: Expression, granularity: Expression): Expression =
     ...
     */
    @JvmStatic
    fun timestampTrunc(fieldName: String, granularity: String): Expression =
     ...
     * ```kotlin
     * // Truncate the 'createdAt' timestamp to the beginning of the day.
     * timestampTrunc("createdAt", field("granularity"))
     * ```
     *
     * @param fieldName The name of the field containing the timestamp.
     * @param granularity The granularity expression to truncate to. Valid values are "microsecond",
     ...
     */
    @JvmStatic
    fun timestampTrunc(fieldName: String, granularity: Expression): Expression =
     ...
     * // timezone.
     * timestampTrunc(field("createdAt"), "day", "America/Los_Angeles")
     * ```
     *
     * @param timestamp The timestamp expression.
     * @param granularity The granularity to truncate to. Valid values are "microsecond",
     ...
     */
    @JvmStatic
    fun timestampTrunc(timestamp: Expression, granularity: String, timezone: String): Expression =
      FunctionExpression(
        "timestamp_trunc",
        notImplemented,
        timestamp,
     ...
     * // Truncate the 'createdAt' timestamp to the beginning of the day in "America/Los_Angeles"
     * // timezone.
     * timestampTrunc(field("createdAt"), field("granularity"), "America/Los_Angeles")
     * ```
     *
     * @param timestamp The timestamp expression.
     * @param granularity The granularity expression to truncate to. Valid values are "microsecond",
     ...
     * // Truncate the 'createdAt' timestamp to the beginning of the day in "America/Los_Angeles"
     * // timezone.
     * timestampTrunc("createdAt", "day", "America/Los_Angeles")
     * ```
     *
     * @param fieldName The name of the field containing the timestamp.
     * @param granularity The granularity to truncate to. Valid values are "microsecond",
     ...
     */
    @JvmStatic
    fun timestampTrunc(fieldName: String, granularity: String, timezone: String): Expression =
      FunctionExpression(
        "timestamp_trunc",
        notImplemented,
        field(fieldName),
     ...
     * // Truncate the 'createdAt' timestamp to the beginning of the day in "America/Los_Angeles"
     * // timezone.
     * timestampTrunc("createdAt", field("granularity"), "America/Los_Angeles")
     * ```
     *
     * @param fieldName The name of the field containing the timestamp.
     * @param granularity The granularity expression to truncate to. Valid values are "microsecond",
     ...
     */
    @JvmStatic
    fun timestampTrunc(fieldName: String, granularity: Expression, timezone: String): Expression =
      FunctionExpression(
        "timestamp_trunc",
        notImplemented,
        field(fieldName),
   ...
   * ```kotlin
   * // Truncate the 'createdAt' timestamp to the beginning of the day.
   * field("createdAt").timestampTrunc("day")
   * ```
   *
   * @param granularity The granularity to truncate to. Valid values are "microsecond",
   * "millisecond", "second", "minute", "hour", "day", "week", "week(monday)", "week(tuesday)",
   ...
   * @return A new [Expression] representing the truncated timestamp.
   */
  fun timestampTrunc(granularity: String): Expression = Expression.timestampTrunc(this, granularity)
   ...
   * ```kotlin
   * // Truncate the 'createdAt' timestamp to the beginning of the day.
   * field("createdAt").timestampTrunc(field("granularity"))
   * ```
   *
   * @param granularity The granularity expression to truncate to. Valid values are "microsecond",
   * "millisecond", "second", "minute", "hour", "day", "week", "week(monday)", "week(tuesday)",
   ...
   * @return A new [Expression] representing the truncated timestamp.
   */
  fun timestampTrunc(granularity: Expression): Expression =
    Expression.timestampTrunc(this, granularity)
