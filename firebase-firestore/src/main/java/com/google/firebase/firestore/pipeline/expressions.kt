...
abstract class Expression internal constructor() {
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun constant(value: VectorValue): Expression = Constant(encodeValue(value))
         ...
         */
        @JvmStatic
        fun vector(vector: VectorValue): Expression = Constant(encodeValue(vector))
        ...
        fun bitNot(bits: Expression): Expression =
            FunctionExpression("bit_not", notImplemented, bits)
        ...
        fun abs(numericField: String): Expression =
            FunctionExpression("abs", evaluateAbs, numericField)
        ...
        fun exp(numericField: String): Expression =
            FunctionExpression("exp", evaluateExp, numericField)
        ...
        fun ln(numericExpr: Expression): Expression =
            FunctionExpression("ln", evaluateLn, numericExpr)
        ...
        fun ln(numericField: String): Expression =
            FunctionExpression("ln", evaluateLn, numericField)
        ...
        fun type(fieldName: String): Expression =
            FunctionExpression("type", notImplemented, fieldName)
        ...
        fun length(expr: Expression): Expression =
            FunctionExpression("length", evaluateLength, expr)
         ...
         */
        @JvmStatic
        internal fun rand(): Expression = FunctionExpression("rand", notImplemented)
        ...
        fun trim(fieldName: String): Expression =
            FunctionExpression("trim", evaluateTrim, fieldName)
        ...
        fun map(elements: Map<String, Any>): Expression =
            map(elements.flatMap { listOf(constant(it.key), toExprOrConstant(it.value)) }
                .toTypedArray())
        ...
        fun mapMerge(
            ...
            FunctionExpression("map_merge", notImplemented, firstMap, secondMap, *otherMaps)
        ...
        fun array(elements: List<Any?>): Expression =
            FunctionExpression(
                "array",
                evaluateArray,
                elements.map(::toExprOrConstant).toTypedArray()
            )
        ...
        fun arraySum(array: Expression): Expression =
            FunctionExpression("sum", notImplemented, array)
        ...
        fun conditional(
            ...
            FunctionExpression("conditional", evaluateCond, condition, thenExpr, elseExpr)
         ...
         */
        @JvmStatic
        fun collectionId(pathField: String): Expression = collectionId(field(pathField))
         ...
         */
        @JvmStatic
        fun documentId(documentPath: String): Expression = documentId(constant(documentPath))
         ...
         */
        @JvmStatic
        fun documentId(docRef: DocumentReference): Expression = documentId(constant(docRef))
         ...
         * @remarks This Expression can only be used within a `Search` stage.
         *
         * @param expression - Specifies the field in the document which contains
         * the first GeoPoint for distance computation.
         * @param location - Compute distance to this GeoPoint.
         */
        @JvmStatic
    ...
    fun bitRightShift(numberExpr: Expression): Expression =
        Companion.bitRightShift(this, numberExpr)
    ...
    fun join(delimiterExpression: Expression): Expression =
        Companion.join(this, delimiterExpression)
    ...
    fun regexContains(pattern: Expression): BooleanExpression =
        Companion.regexContains(this, pattern)
    ...
    fun euclideanDistance(vector: Expression): Expression =
        Companion.euclideanDistance(this, vector)
    ...
    fun arrayContains(element: Expression): BooleanExpression =
        Companion.arrayContains(this, element)
    ...
    fun greaterThanOrEqual(value: Any): BooleanExpression =
        Companion.greaterThanOrEqual(this, value)
    ...
    fun lessThanOrEqual(other: Expression): BooleanExpression =
        Companion.lessThanOrEqual(this, other)
     ...
     * TODO(documentation)
     */
    fun snippet(options: SnippetOptions): Expression {
        throw NotImplementedError("Not implemented");
    }
...
class Field internal constructor(internal val fieldPath: ModelFieldPath) : Selectable() {
    companion object {
         ...
         */
        @JvmField
        internal val DOCUMENT_ID: Field = Field(KEY_PATH)

        @JvmField
        internal val UPDATE_TIME: Field = Field(UPDATE_TIME_PATH)

        @JvmField
        internal val CREATE_TIME: Field = Field(CREATE_TIME_PATH)
    }
    ...
    private fun getServerTimestamp(fieldValue: Value, context: EvaluationContext): EvaluateResult {
        ...
        return when (behavior) {
            ...
            DocumentSnapshot.ServerTimestampBehavior.PREVIOUS -> {
                ...
                if (previousValue == null) EvaluateResult.NULL else EvaluateResultValue(
                    previousValue!!
                )
            }
        }
...
internal constructor(
    ...
    internal constructor(
        ...
        name,
        FunctionRegistry.functions[name] ?: notImplemented,
        params.toTypedArray(),
        options
    )
...
class Ordering internal constructor(val expr: Expression, val dir: Direction) {
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun ascending(expr: Expression): Ordering = Ordering(expr, Direction.ASCENDING)
         ...
         */
        @JvmStatic
        fun descending(expr: Expression): Ordering = Ordering(expr, Direction.DESCENDING)
        ...
        fun descending(fieldName: String): Ordering =
            Ordering(field(fieldName), Direction.DESCENDING)
    }
