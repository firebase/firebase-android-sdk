...
public final class GracefulSwitchLoadBalancer extends ForwardingLoadBalancer {
  private final LoadBalancer defaultBalancer =
      new LoadBalancer() {
        ...
        public void handleResolvedAddresses(ResolvedAddresses resolvedAddresses) {
          ...
          //  handleResolvedAddresses(), within their own handleResolvedAddresses(). If switchTo()
          // is
          //  not called immediately after construction that does open up potential for bugs in the
          //  parent policies, where they fail to call switchTo(). So we will use the exception to
          // try
  ...
  @VisibleForTesting
  static final SubchannelPicker BUFFER_PICKER =
