 ...
 * them by closing the {@link ServerCall}, and transmitting the exception's status and metadata to
 * the client.
 *
 * <p>Without this interceptor, gRPC will strip all details and close the {@link ServerCall} with a
 * generic {@link Status#UNKNOWN} code.
 *
 * <p>Security warning: the {@link Status} and {@link Metadata} may contain sensitive server-side
 * state information, and generally should not be sent to clients. Only install this interceptor if
