...
public final class CertificateUtils {
  /**
   * Generates X509Certificate array from a PEM file. The PEM file should contain one or more items
   * in Base64 encoding, each with plain-text headers and footers (e.g. -----BEGIN CERTIFICATE-----
   * and -----END CERTIFICATE-----).
   *
  ...
  /**
   * Generates a {@link PrivateKey} from a PEM file. The key should be PKCS #8 formatted. The key
   * algorithm should be "RSA" or "EC". The PEM file should contain one item in Base64 encoding,
   * with plain-text headers and footers (e.g. -----BEGIN PRIVATE KEY----- and -----END PRIVATE
   * KEY-----).
   *
