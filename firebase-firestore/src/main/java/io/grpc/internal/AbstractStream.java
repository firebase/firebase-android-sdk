...
public abstract class AbstractStream implements Stream {
  ...
  public abstract static class TransportState
    ...
    protected TransportState(
      ...
      rawDeframer =
          new MessageDeframer(
              this, Codec.Identity.NONE, maxMessageSize, statsTraceCtx, transportTracer);
    ...
    /**
     * Very rarely used. Prefer stream.request() instead of this; this method is only necessary if a
