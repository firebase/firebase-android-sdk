...
/**
 * {@link ServiceConfigState} holds the state of the current service config. It must be mutated and
 * read from {@link io.grpc.internal.ManagedChannelImpl} constructor or the provided syncContext.
 */
final class ServiceConfigState {
   ...
   */
  ServiceConfigState(
      @Nullable ManagedChannelServiceConfig defaultServiceConfig, boolean lookUpServiceConfig) {
   ...
   *   <li>There is a valid default service config and a service config error from the name resolver
