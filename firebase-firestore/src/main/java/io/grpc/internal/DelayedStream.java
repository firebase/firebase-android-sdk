 ...
 * necessary.
 */
class DelayedStream implements io.grpc.internal.ClientStream {
  ...
  // be true
  @CheckReturnValue
  final Runnable setStream(io.grpc.internal.ClientStream stream) {
  ...
  public Attributes getAttributes() {
    io.grpc.internal.ClientStream savedRealStream;
    synchronized (this) {
  ...
  @GuardedBy("this")
  private void setRealStream(io.grpc.internal.ClientStream realStream) {
