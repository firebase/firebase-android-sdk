...
/**
 * A {@link io.grpc.internal.ClientTransport} that has life-cycle management.
 *
 ...
 * contract defined by {@link #shutdown}, {@link Listener#transportShutdown} and {@link
...
public interface ManagedClientTransport extends ClientTransport {
   ...
   * will not own any new streams. New streams will either fail (once {@link
   * Listener#transportShutdown} callback called), or be transferred off this transport (in which
   * case they may succeed). This method may only be called once.
   */
