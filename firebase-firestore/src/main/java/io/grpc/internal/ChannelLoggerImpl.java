...
final class ChannelLoggerImpl extends ChannelLogger {
  private final io.grpc.internal.ChannelTracer tracer;
  private final io.grpc.internal.TimeProvider time;

  ChannelLoggerImpl(io.grpc.internal.ChannelTracer tracer, TimeProvider time) {
  ...
  public void log(ChannelLogLevel level, String messageFormat, Object... args) {
    ...
    if (isTraceable(level) || io.grpc.internal.ChannelTracer.logger.isLoggable(javaLogLevel)) {
  ...
  static void logOnly(InternalLogId logId, ChannelLogLevel level, String msg) {
    Level javaLogLevel = toJavaLogLevel(level);
    if (io.grpc.internal.ChannelTracer.logger.isLoggable(javaLogLevel)) {
      io.grpc.internal.ChannelTracer.logOnly(logId, javaLogLevel, msg);
    }
  }
