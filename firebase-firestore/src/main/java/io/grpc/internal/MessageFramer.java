...
public class MessageFramer implements Framer {
  ...
  /**
   * Indicates whether or not this framer has been closed via a call to either {@link #close()} or
   * {@link #dispose()}.
   */
  @Override
  ...
  /**
   * Flushes and closes the framer and releases any buffers. After the framer is closed or disposed,
   * additional calls to this method will have no affect.
   */
  @Override
  public void close() {
    if (!isClosed()) {
  ...
  /**
   * Closes the framer and releases any buffers, but does not flush. After the framer is closed or
  ...
  private class OutputStreamAdapter extends OutputStream {
     ...
     * Better yet, you can use your own single byte buffer and call {@link #write(byte[], int,
     * int)}.
     */
    @Override
  ...
  /**
   * Produce a collection of {@link WritableBuffer} instances from the data written to an {@link
   * OutputStream}.
   */
