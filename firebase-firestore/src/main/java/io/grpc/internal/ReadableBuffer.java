...
public interface ReadableBuffer extends Closeable {
   ...
   * is implementation specific. The position of this buffer is unchanged after calling this method.
   * The returned buffer's content should not be modified, but the position, limit, and mark may be
   * changed. Operations for changing the position, limit, and mark of the returned buffer does not
   * affect the position, limit, and mark of this buffer. Buffers returned by this method have
   * independent position, limit and mark. This is an optional method, so callers should first check
   * {@link #byteBufferSupported}.
   *
   * @throws UnsupportedOperationException the buffer does not support this method.
   */
  @Nullable
