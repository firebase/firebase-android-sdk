...
public final class AutoConfiguredLoadBalancerFactory {
  ...
  public final class AutoConfiguredLoadBalancer {
    ...
    Status tryHandleResolvedAddresses(ResolvedAddresses resolvedAddresses) {
      ...
      if (policySelection == null) {
        ...
        policySelection = new PolicySelection(defaultProvider, /* config= */ null);
      }
      ...
      if (lbConfig != null) {
        helper
            .getChannelLogger()
            .log(ChannelLogLevel.DEBUG, "Load-balancing config: {0}", policySelection.config);
      }
   ...
   *
   * <ol>
   *   <li>Policy from "loadBalancingConfig" if present
   *   <li>The policy from deprecated "loadBalancingPolicy" if present
   * </ol>
   *
    ...
    try {
      ...
      if (serviceConfig != null) {
        List<Map<String, ?>> rawLbConfigs =
            io.grpc.internal.ServiceConfigUtil.getLoadBalancingConfigsFromServiceConfig(
                serviceConfig);
        loadBalancerConfigs =
            io.grpc.internal.ServiceConfigUtil.unwrapLoadBalancingConfigList(rawLbConfigs);
      }
