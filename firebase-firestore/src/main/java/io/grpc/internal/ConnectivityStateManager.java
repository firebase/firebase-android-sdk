 ...
 * current state of the channel, for {@link ManagedChannel#notifyWhenStateChanged} to add listeners
 * to state change events, and for {@link io.grpc.LoadBalancer.Helper#updateBalancingState
