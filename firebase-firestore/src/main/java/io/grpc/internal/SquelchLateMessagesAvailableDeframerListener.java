 ...
 * deframing is complete. Since the producer may not be run, it must not hold resources or it should
 * implement {@link Closeable}.
 */
final class SquelchLateMessagesAvailableDeframerListener
    extends io.grpc.internal.ForwardingDeframerListener {
  private final io.grpc.internal.MessageDeframer.Listener delegate;
  private boolean closed;

  public SquelchLateMessagesAvailableDeframerListener(
      io.grpc.internal.MessageDeframer.Listener delegate) {
