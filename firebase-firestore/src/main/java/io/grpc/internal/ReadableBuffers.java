...
/** Utility methods for creating {@link io.grpc.internal.ReadableBuffer} instances. */
public final class ReadableBuffers {
  private static final io.grpc.internal.ReadableBuffer EMPTY_BUFFER =
      new ByteArrayWrapper(new byte[0]);

  /** Returns an empty {@link io.grpc.internal.ReadableBuffer} instance. */
  public static io.grpc.internal.ReadableBuffer empty() {
    return EMPTY_BUFFER;
  }

  /** Shortcut for {@code wrap(bytes, 0, bytes.length}. */
  public static io.grpc.internal.ReadableBuffer wrap(byte[] bytes) {
    return new ByteArrayWrapper(bytes, 0, bytes.length);
  }

  /**
   * Creates a new {@link io.grpc.internal.ReadableBuffer} that is backed by the given byte array.
   *
   ...
   */
  public static io.grpc.internal.ReadableBuffer wrap(byte[] bytes, int offset, int length) {
    return new ByteArrayWrapper(bytes, offset, length);
  }

  /**
   * Creates a new {@link io.grpc.internal.ReadableBuffer} that is backed by the given {@link
   * ByteBuffer}. Calls to read from the buffer will increment the position of the {@link
   * ByteBuffer}.
   */
  public static io.grpc.internal.ReadableBuffer wrap(ByteBuffer bytes) {
    return new ByteReadableBufferWrapper(bytes);
  }

  /**
   * Reads an entire {@link io.grpc.internal.ReadableBuffer} to a new array. After calling this
   * method, the buffer will contain no readable bytes.
   */
  public static byte[] readArray(io.grpc.internal.ReadableBuffer buffer) {
  ...
  /**
   * Reads the entire {@link io.grpc.internal.ReadableBuffer} to a new {@link String} with the given
   * charset.
   */
  public static String readAsString(io.grpc.internal.ReadableBuffer buffer, Charset charset) {
  ...
  /**
   * Reads the entire {@link io.grpc.internal.ReadableBuffer} to a new {@link String} using UTF-8
   * decoding.
   */
  public static String readAsStringUtf8(io.grpc.internal.ReadableBuffer buffer) {
   ...
   */
  public static InputStream openStream(io.grpc.internal.ReadableBuffer buffer, boolean owner) {
    return new BufferInputStream(owner ? buffer : ignoreClose(buffer));
  }

  /**
   * Decorates the given {@link io.grpc.internal.ReadableBuffer} to ignore calls to {@link
   * io.grpc.internal.ReadableBuffer#close}.
   *
   * @param buffer the buffer to be decorated.
   * @return a wrapper around {@code buffer} that ignores calls to {@link
   *     io.grpc.internal.ReadableBuffer#close}.
   */
  public static io.grpc.internal.ReadableBuffer ignoreClose(
  ...
  /** A {@link io.grpc.internal.ReadableBuffer} that is backed by a byte array. */
  ...
  /** A {@link io.grpc.internal.ReadableBuffer} that is backed by a {@link ByteBuffer}. */
  ...
  /** An {@link InputStream} that is backed by a {@link io.grpc.internal.ReadableBuffer}. */
  private static final class BufferInputStream extends InputStream
      implements KnownLength, HasByteBuffer, Detachable {
    private io.grpc.internal.ReadableBuffer buffer;

    public BufferInputStream(io.grpc.internal.ReadableBuffer buffer) {
