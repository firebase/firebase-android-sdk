 ...
 * However, streams created before the client has discovered any server address may eventually be
 * issued on different connections. All methods on the transport and its callbacks are expected to
 * execute quickly.
 */
@ThreadSafe
