...
final class OobChannel extends ManagedChannel implements InternalInstrumented<ChannelStats> {
  ...
  private final ClientStreamProvider transportProvider =
      new ClientStreamProvider() {
        @Override
        public ClientStream newStream(
          ...
          // doesn't
          // matter here because OOB communication should be sparse, and it's not on application
          // RPC's
          // critical path.
          try {
