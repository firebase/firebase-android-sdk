...
public class KeepAliveManager {
            ...
            public void run() {
              ...
              synchronized (KeepAliveManager.this) {
                if (state != State.DISCONNECTED) {
                  // We haven't received a ping response within the timeout. The connection is
                  // likely gone
            ...
            public void run() {
              ...
              synchronized (KeepAliveManager.this) {
                ...
                if (state == State.PING_SCHEDULED) {
                  ...
                  // Schedule a shutdown. It fires if we don't receive the ping response within the
                  // timeout.
                  shutdownFuture =
  ...
  public static final class ClientKeepAlivePinger implements KeepAlivePinger {
    ...
    public void ping() {
      transport.ping(
          new ClientTransport.PingCallback() {
            @Override
