 ...
 *
 * <p>The {@code Executor} assumes that reentrant calls are rare and its fast path is thus optimized
 * for that - avoiding queuing and additional object creation altogether.
 *
