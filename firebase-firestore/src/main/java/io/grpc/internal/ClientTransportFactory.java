...
public interface ClientTransportFactory extends Closeable {
   ...
   * any outstanding tasks are cancelled before the factory is closed. However, it is a <a
   * href="https://github.com/grpc/grpc-java/issues/1981">known issue</a> that ClientCallImpl may
   ...
   *
   * <p>After this method has been called, it's no longer valid to call {@link #newClientTransport}.
