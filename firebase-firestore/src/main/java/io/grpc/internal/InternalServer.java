...
/**
 * An object that accepts new incoming connections on one or more listening socket addresses. This
 * would commonly encapsulate a bound socket that {@code accept()}s new connections.
 */
@ThreadSafe
public interface InternalServer {
  ...
  /**
   * Returns a list of listening socket addresses. May change after {@link start(ServerListener)} is
   * called.
   */
