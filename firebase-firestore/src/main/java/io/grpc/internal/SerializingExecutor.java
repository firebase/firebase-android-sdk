...
/**
 * Executor ensuring that all {@link Runnable} tasks submitted are executed in order using the
 * provided {@link Executor}, and serially such that no two will ever be running at the same time.
 */
