...
/**
 * Helper utility to work with JSON values in Java types. Includes the JSON dialect used by Protocol
 * Buffers.
 */
public class JsonUtil {
  /**
   * Gets a list from an object for the given key. If the key is not present, this returns null. If
   * the value is not a List, throws an exception.
   */
  @Nullable
  ...
  /**
   * Gets a number from an object for the given key, casted to an long. If the key is not present,
   * this returns null. If the value does not represent a long integer, throws an exception.
   */
  ...
  /**
   * Casts a list of unchecked JSON values to a list of checked objects in Java type. If the given
   * list contains a value that is not a Map, throws an exception.
   */
  @SuppressWarnings("unchecked")
  ...
  /**
   * Casts a list of unchecked JSON values to a list of String. If the given list contains a value
   * that is not a String, throws an exception.
   */
  @SuppressWarnings("unchecked")
  ...
  /**
   * Parse from a string to produce a duration. Copy of {@link
   ...
   *
   * <p>Copy of {@link com.google.protobuf.util.Duration#isValid}.
   */
   ...
   *
   * <p>Copy of {@link com.google.common.math.LongMath#saturatedAdd}.
   */
