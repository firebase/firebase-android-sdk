 ...
 *
 * <p>Does not call the delegate's {@code messagesAvailable()}. It's expected that {@code
 * messageReadQueuePoll()} is called on the application thread from within a message producer
 * managed elsewhere.
 */
final class ApplicationThreadDeframerListener implements io.grpc.internal.MessageDeframer.Listener {
