...
public class Http2Ping {
  ...
  /**
   * The round-trip time for the ping, in nanoseconds. This value is only meaningful when {@link
   * #completed} is true and {@link #failureCause} is null.
   */
  @GuardedBy("this")
  ...
  /**
   * Completes this operation exceptionally. Registered callbacks are invoked and provided the given
   * throwable as the cause of failure.
   *
