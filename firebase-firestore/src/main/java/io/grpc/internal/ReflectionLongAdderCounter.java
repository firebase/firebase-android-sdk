...
/**
 * A {@link io.grpc.internal.LongCounter} that is implemented with a JDK8 {@link LongAdder}.
 * Instantiates the object and invokes methods reflectively to avoid a compile time dependency on
 * LongAdder.
 */
