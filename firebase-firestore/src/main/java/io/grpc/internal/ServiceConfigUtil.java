...
public final class ServiceConfigUtil {
  ...
  public static Map<String, ?> getHealthCheckedService(@Nullable Map<String, ?> serviceConfig) {
    ...
    */
    return io.grpc.internal.JsonUtil.getObject(serviceConfig, "healthCheckConfig");
  }
  ...
  public static String getHealthCheckedServiceName(
    ...
    return io.grpc.internal.JsonUtil.getString(healthCheckedServiceConfig, "serviceName");
  }
  ...
  static Throttle getThrottlePolicy(@Nullable Map<String, ?> serviceConfig) {
    ...
    */
    ...
    Map<String, ?> throttling =
        io.grpc.internal.JsonUtil.getObject(serviceConfig, "retryThrottling");
    if (throttling == null) {
      return null;
    }
    ...
    float maxTokens =
        io.grpc.internal.JsonUtil.getNumberAsDouble(throttling, "maxTokens").floatValue();
    float tokenRatio =
        io.grpc.internal.JsonUtil.getNumberAsDouble(throttling, "tokenRatio").floatValue();
  ...
  static Integer getMaxAttemptsFromRetryPolicy(Map<String, ?> retryPolicy) {
    return io.grpc.internal.JsonUtil.getNumberAsInteger(retryPolicy, "maxAttempts");
  }

  @Nullable
  static Long getInitialBackoffNanosFromRetryPolicy(Map<String, ?> retryPolicy) {
    return io.grpc.internal.JsonUtil.getStringAsDuration(retryPolicy, "initialBackoff");
  }

  @Nullable
  static Long getMaxBackoffNanosFromRetryPolicy(Map<String, ?> retryPolicy) {
    return io.grpc.internal.JsonUtil.getStringAsDuration(retryPolicy, "maxBackoff");
  }

  @Nullable
  static Double getBackoffMultiplierFromRetryPolicy(Map<String, ?> retryPolicy) {
    return io.grpc.internal.JsonUtil.getNumberAsDouble(retryPolicy, "backoffMultiplier");
  }

  @Nullable
  static Long getPerAttemptRecvTimeoutNanosFromRetryPolicy(Map<String, ?> retryPolicy) {
    return io.grpc.internal.JsonUtil.getStringAsDuration(retryPolicy, "perAttemptRecvTimeout");
  }

  private static Set<Status.Code> getListOfStatusCodesAsSet(Map<String, ?> obj, String key) {
    List<?> statuses = io.grpc.internal.JsonUtil.getList(obj, key);
    if (statuses == null) {
      return null;
    }
      ...
      if (status instanceof Double) {
        ...
        throw new VerifyException(
            "Can not convert status code "
                + status
                + " to Status.Code, because its type is "
                + status.getClass());
      }
      codes.add(code);
    }
  ...
  static Integer getMaxAttemptsFromHedgingPolicy(Map<String, ?> hedgingPolicy) {
    return io.grpc.internal.JsonUtil.getNumberAsInteger(hedgingPolicy, "maxAttempts");
  }

  @Nullable
  static Long getHedgingDelayNanosFromHedgingPolicy(Map<String, ?> hedgingPolicy) {
    return io.grpc.internal.JsonUtil.getStringAsDuration(hedgingPolicy, "hedgingDelay");
  }
  ...
  static String getServiceFromName(Map<String, ?> name) {
    return io.grpc.internal.JsonUtil.getString(name, "service");
  }

  @Nullable
  static String getMethodFromName(Map<String, ?> name) {
    return io.grpc.internal.JsonUtil.getString(name, "method");
  }

  @Nullable
  static Map<String, ?> getRetryPolicyFromMethodConfig(Map<String, ?> methodConfig) {
    return io.grpc.internal.JsonUtil.getObject(methodConfig, "retryPolicy");
  }

  @Nullable
  static Map<String, ?> getHedgingPolicyFromMethodConfig(Map<String, ?> methodConfig) {
    return io.grpc.internal.JsonUtil.getObject(methodConfig, "hedgingPolicy");
  }

  @Nullable
  static List<Map<String, ?>> getNameListFromMethodConfig(Map<String, ?> methodConfig) {
    return io.grpc.internal.JsonUtil.getListOfObjects(methodConfig, "name");
  }
  ...
  static Long getTimeoutFromMethodConfig(Map<String, ?> methodConfig) {
    return io.grpc.internal.JsonUtil.getStringAsDuration(methodConfig, "timeout");
  }

  @Nullable
  static Boolean getWaitForReadyFromMethodConfig(Map<String, ?> methodConfig) {
    return io.grpc.internal.JsonUtil.getBoolean(methodConfig, "waitForReady");
  }

  @Nullable
  static Integer getMaxRequestMessageBytesFromMethodConfig(Map<String, ?> methodConfig) {
    return io.grpc.internal.JsonUtil.getNumberAsInteger(methodConfig, "maxRequestMessageBytes");
  }

  @Nullable
  static Integer getMaxResponseMessageBytesFromMethodConfig(Map<String, ?> methodConfig) {
    return io.grpc.internal.JsonUtil.getNumberAsInteger(methodConfig, "maxResponseMessageBytes");
  }

  @Nullable
  static List<Map<String, ?>> getMethodConfigFromServiceConfig(Map<String, ?> serviceConfig) {
    return io.grpc.internal.JsonUtil.getListOfObjects(serviceConfig, "methodConfig");
  }
  ...
  public static List<Map<String, ?>> getLoadBalancingConfigsFromServiceConfig(
    ...
    */
    ...
    if (serviceConfig.containsKey(loadBalancingConfigKey)) {
      lbConfigs.addAll(
          io.grpc.internal.JsonUtil.getListOfObjects(serviceConfig, loadBalancingConfigKey));
    }
    if (lbConfigs.isEmpty()) {
      // No LoadBalancingConfig found.  Fall back to the deprecated LoadBalancingPolicy
      String policy = io.grpc.internal.JsonUtil.getString(serviceConfig, "loadBalancingPolicy");
      if (policy != null) {
    ...
    for (LbConfig lbConfig : lbConfigs) {
      ...
      if (provider == null) {
        ...
        if (!policiesTried.isEmpty()) {
          Logger.getLogger(ServiceConfigUtil.class.getName())
              .log(
                  Level.FINEST, "{0} specified by Service Config are not available", policiesTried);
        }
  ...
  public static final class LbConfig {
    ...
    public boolean equals(Object o) {
      if (o instanceof LbConfig) {
        ...
        return policyName.equals(other.policyName) && rawConfigValue.equals(other.rawConfigValue);
      }
      return false;
    }
  ...
  public static final class PolicySelection {
    ...
    public boolean equals(Object o) {
      ...
      return Objects.equal(provider, that.provider) && Objects.equal(config, that.config);
    }
