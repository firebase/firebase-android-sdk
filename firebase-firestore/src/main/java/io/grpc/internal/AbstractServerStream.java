...
/**
 * Abstract base class for {@link io.grpc.internal.ServerStream} implementations. Extending classes
 * only need to implement {@link #transportState()} and {@link #abstractServerStreamSink()}. Must
 * only be called from the sending application thread.
 */
public abstract class AbstractServerStream extends io.grpc.internal.AbstractStream
    implements io.grpc.internal.ServerStream, io.grpc.internal.MessageFramer.Sink {
  /**
  ...
  protected interface Sink {
     ...
     */
    void writeFrame(
        @Nullable io.grpc.internal.WritableBuffer frame, boolean flush, int numMessages);
  ...
  protected AbstractServerStream(
      WritableBufferAllocator bufferAllocator, io.grpc.internal.StatsTraceContext statsTraceCtx) {
    this.statsTraceCtx = Preconditions.checkNotNull(statsTraceCtx, "statsTraceCtx");
    framer = new io.grpc.internal.MessageFramer(this, bufferAllocator, statsTraceCtx);
  }
  ...
  protected abstract static class TransportState extends AbstractStream.TransportState {
     ...
     *
     * <p>Unlike {@link #close(Status, Metadata)}, this method is only called from the transport.
     * The transport should use this method instead of {@code close(Status)} for internal errors to
     * prevent exposing unexpected states and exceptions to the application.
     *
