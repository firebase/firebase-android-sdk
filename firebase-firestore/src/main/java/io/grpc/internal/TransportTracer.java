...
/**
 * A class for gathering statistics about a transport. This is an experimental feature. Can only be
 * called from the transport thread unless otherwise noted.
 */
public final class TransportTracer {
  ...
  private TransportTracer(io.grpc.internal.TimeProvider timeProvider) {
