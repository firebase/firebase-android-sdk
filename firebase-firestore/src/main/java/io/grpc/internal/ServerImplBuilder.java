...
public final class ServerImplBuilder extends ServerBuilder<ServerImplBuilder> {
  ...
  io.grpc.internal.CallTracer.Factory callTracerFactory =
      io.grpc.internal.CallTracer.getDefaultFactory();
      ...
      try {
        ...
        Method getServerStreamTracerFactoryMethod =
            censusStatsAccessor.getDeclaredMethod(
                "getServerStreamTracerFactory", boolean.class, boolean.class, boolean.class);
        censusStatsTracerFactory =
            (ServerStreamTracer.Factory)
                getServerStreamTracerFactoryMethod.invoke(
                    null, recordStartedRpcs, recordFinishedRpcs, recordRealTimeMetrics);
