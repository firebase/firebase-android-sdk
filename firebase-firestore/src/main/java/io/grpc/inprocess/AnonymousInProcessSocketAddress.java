...
/**
 * Custom SocketAddress class for {@link io.grpc.inprocess.InProcessTransport}, for a server which
...
public final class AnonymousInProcessSocketAddress extends SocketAddress {
  ...
  @Nullable
  @GuardedBy("this")
  private io.grpc.inprocess.InProcessServer server;

  /** Creates a new AnonymousInProcessSocketAddress. */
  public AnonymousInProcessSocketAddress() {}

  @Nullable
  synchronized io.grpc.inprocess.InProcessServer getServer() {
    return server;
  }

  synchronized void setServer(io.grpc.inprocess.InProcessServer server) throws IOException {
    if (this.server != null) {
  ...
  synchronized void clearServer(io.grpc.inprocess.InProcessServer server) {
