 ...
 *
 * <p>This is intended for use by io.grpc.internal, and the specifically supported transport
 * packages.
 */
@Internal
public final class InternalInProcess {
   ...
   *
   * <p>When started, the transport will be registered with the given {@link ServerListener}.
   */
  @Internal
