...
public final class InProcessChannelBuilder
    ...
    if (directAddress != null) {
      managedChannelImplBuilder =
          new ManagedChannelImplBuilder(
              directAddress, "localhost", new InProcessChannelTransportFactoryBuilder(), null);
    } else {
      managedChannelImplBuilder =
          new ManagedChannelImplBuilder(
              target, new InProcessChannelTransportFactoryBuilder(), null);
    }
  ...
  /**
   * Sets whether to include the cause with the status that is propagated forward from the
   * InProcessTransport. This was added to make debugging failing tests easier by showing the cause
   * of the status.
   *
   * <p>By default, this is set to false. A default value of false maintains consistency with other
   * transports which strip causal information from the status to avoid leaking information to
   * untrusted clients, and to avoid sharing language-specific information with the client. For the
   * in-process implementation, this is not a concern.
   *
  ...
  static final class InProcessClientTransportFactory implements ClientTransportFactory {
    ...
    public ConnectionClientTransport newClientTransport(
      ...
      return new io.grpc.inprocess.InProcessTransport(
          addr,
