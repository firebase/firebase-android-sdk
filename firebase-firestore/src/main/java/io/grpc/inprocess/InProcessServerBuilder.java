 ...
 *
 * The class "GrpcServerRule" (from "grpc-java/testing") is a JUnit TestRule that creates a {@link
 * io.grpc.inprocess.InProcessServer} and a {@link io.grpc.ManagedChannel ManagedChannel}. This test
 * rule contains the boilerplate code shown below. The classes "HelloWorldServerTest" and
...
public final class InProcessServerBuilder
  ...
  io.grpc.inprocess.InProcessServer buildTransportServers(
      List<? extends ServerStreamTracer.Factory> streamTracerFactories) {
    return new io.grpc.inprocess.InProcessServer(this, streamTracerFactories);
  }
