...
public class TestUtil {
  ...
  public static LocalViewChanges viewChanges(
      int targetId, boolean hasLimboDocuments, List<String> addedKeys, List<String> removedKeys) {
    ...
    return new LocalViewChanges(targetId, hasLimboDocuments, added, removed);
  }
