...
internal class ArithmeticTests {
    ...
    fun addFunctionTestWithBasicNumerics() {
        assertThat(evaluate(add(constant(1L), constant(2L))).value)
            .isEqualTo(encodeValue(3L))
        assertThat(evaluate(add(constant(1L), constant(2.5))).value)
            .isEqualTo(encodeValue(3.5))
        assertThat(evaluate(add(constant(1.0), constant(2L))).value)
            .isEqualTo(encodeValue(3.0))
        assertThat(evaluate(add(constant(1.0), constant(2.0))).value)
            .isEqualTo(encodeValue(3.0))
    }
    ...
    fun addFunctionTestWithSumPosAndNegInfinityReturnNaN() {
        assertThat(evaluate(add(constant(Double.POSITIVE_INFINITY), constant(Double.NEGATIVE_INFINITY))).value)
    ...
    fun addFunctionTestWithNanNumberReturnNaN() {
        ...
        assertThat(evaluate(add(constant(1L), constant(nanVal))).value)
            .isEqualTo(encodeValue(nanVal))
        assertThat(evaluate(add(constant(1.0), constant(nanVal))).value)
            .isEqualTo(encodeValue(nanVal))
        ...
        assertThat(evaluate(add(constant(Double.MAX_VALUE), constant(nanVal))).value)
            .isEqualTo(encodeValue(nanVal))
        assertThat(evaluate(add(constant(-Double.MAX_VALUE), constant(nanVal))).value) // Corresponds to C++ std::numeric_limits<double>::lowest()
            .isEqualTo(encodeValue(nanVal))
    ...
    fun subtractFunctionTestWithBasicNumerics() {
        assertThat(evaluate(subtract(constant(1L), constant(2L))).value)
            .isEqualTo(encodeValue(-1L))
        assertThat(evaluate(subtract(constant(1L), constant(2.5))).value)
            .isEqualTo(encodeValue(-1.5))
        assertThat(evaluate(subtract(constant(1.0), constant(2L))).value)
            .isEqualTo(encodeValue(-1.0))
        assertThat(evaluate(subtract(constant(1.0), constant(2.0))).value)
            .isEqualTo(encodeValue(-1.0))
    }
    ...
    fun subtractFunctionTestWithPositiveInfinityNegativeInfinity() {
        assertThat(evaluate(subtract(constant(Double.POSITIVE_INFINITY), constant(Double.NEGATIVE_INFINITY))).value)
            .isEqualTo(encodeValue(Double.POSITIVE_INFINITY))
        assertThat(evaluate(subtract(constant(Double.NEGATIVE_INFINITY), constant(Double.POSITIVE_INFINITY))).value)
            .isEqualTo(encodeValue(Double.NEGATIVE_INFINITY))
    }
    ...
    fun multiplyFunctionTestWithBasicNumerics() {
        assertThat(evaluate(multiply(constant(1L), constant(2L))).value)
            .isEqualTo(encodeValue(2L))
        assertThat(evaluate(multiply(constant(3L), constant(2.5))).value)
            .isEqualTo(encodeValue(7.5))
        assertThat(evaluate(multiply(constant(1.0), constant(2L))).value)
            .isEqualTo(encodeValue(2.0))
        assertThat(evaluate(multiply(constant(1.32), constant(2.0))).value)
            .isEqualTo(encodeValue(2.64))
    }
    ...
    fun multiplyFunctionTestWithPositiveInfinityNegativeInfinityReturnsNegativeInfinity() {
        assertThat(evaluate(multiply(constant(Double.POSITIVE_INFINITY), constant(Double.NEGATIVE_INFINITY))).value)
            .isEqualTo(encodeValue(Double.NEGATIVE_INFINITY))
        assertThat(evaluate(multiply(constant(Double.NEGATIVE_INFINITY), constant(Double.POSITIVE_INFINITY))).value)
            .isEqualTo(encodeValue(Double.NEGATIVE_INFINITY))
    }
    ...
    fun divideFunctionTestWithBasicNumerics() {
        assertThat(evaluate(divide(constant(10L), constant(2L))).value)
            .isEqualTo(encodeValue(5L))
        assertThat(evaluate(divide(constant(10L), constant(2.0))).value)
    ...
    fun divideFunctionTestWithLongDivision() {
        assertThat(evaluate(divide(constant(10L), constant(3L))).value)
            .isEqualTo(encodeValue(3L))
        assertThat(evaluate(divide(constant(-10L), constant(3L))).value)
            .isEqualTo(encodeValue(-3L))
        assertThat(evaluate(divide(constant(10L), constant(-3L))).value)
    ...
    fun divideFunctionTestWithPositiveInfinityNegativeInfinityReturnsNan() {
        assertThat(evaluate(divide(constant(Double.POSITIVE_INFINITY), constant(Double.NEGATIVE_INFINITY))).value)
            .isEqualTo(encodeValue(Double.NaN))
        assertThat(evaluate(divide(constant(Double.NEGATIVE_INFINITY), constant(Double.POSITIVE_INFINITY))).value)
            .isEqualTo(encodeValue(Double.NaN))
    }
    ...
    fun modFunctionTestWithDividendZeroReturnsZero() {
        assertThat(evaluate(mod(constant(0L), constant(42L))).value)
            .isEqualTo(encodeValue(0L))
        assertThat(evaluate(mod(constant(0.0), constant(42.0))).value)
            .isEqualTo(encodeValue(0.0))
        assertThat(evaluate(mod(constant(-0.0), constant(42.0))).value)
            .isEqualTo(encodeValue(-0.0))
    }
    ...
    fun modFunctionTestWithLongPositivePositive() {
        assertThat(evaluate(mod(constant(10L), constant(3L))).value)
            .isEqualTo(encodeValue(1L))
    }
    ...
    fun modFunctionTestWithDoublePositivePositive() {
        ...
        assertThat(evaluate(mod(constant(10.5), constant(3.0))).value)
            .isEqualTo(encodeValue(1.5))
    }
    ...
    fun modFunctionTestWithLongPerfectlyDivisible() {
        assertThat(evaluate(mod(constant(10L), constant(5L))).value)
            .isEqualTo(encodeValue(0L))
        assertThat(evaluate(mod(constant(-10L), constant(5L))).value)
            .isEqualTo(encodeValue(0L))
        assertThat(evaluate(mod(constant(10L), constant(-5L))).value)
    ...
    fun modFunctionTestWithDoublePerfectlyDivisible() {
        assertThat(evaluate(mod(constant(10.0), constant(2.5))).value)
            .isEqualTo(encodeValue(0.0))
        assertThat(evaluate(mod(constant(10.0), constant(-2.5))).value)
            .isEqualTo(encodeValue(0.0))
        assertThat(evaluate(mod(constant(-10.0), constant(2.5))).value)
    ...
    fun modFunctionTestWithNanNumberReturnNaN() {
        val nanVal = Double.NaN
        assertThat(evaluate(mod(constant(1L), constant(nanVal))).value)
            .isEqualTo(encodeValue(nanVal))
        assertThat(evaluate(mod(constant(1.0), constant(nanVal))).value)
            .isEqualTo(encodeValue(nanVal))
    ...
    fun modFunctionTestWithPosAndNegInfinityReturnNaN() {
        assertThat(evaluate(mod(constant(Double.POSITIVE_INFINITY), constant(Double.NEGATIVE_INFINITY))).value)
            .isEqualTo(encodeValue(Double.NaN))
    }
}
