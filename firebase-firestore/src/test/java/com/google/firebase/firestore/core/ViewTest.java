...
public class ViewTest {
  ...
  public void testAddsDocumentsBasedOnQuery() {
    ...
    ImmutableHashMap<DocumentKey, Document> updates = docUpdates(doc1, doc2, doc3);
  ...
  public void testResumingQueryCreatesNoLimbos() {
    ...
    View view = new View(query, ImmutableHashSet.of(doc1.getKey(), doc2.getKey()));
  ...
  public void testComputesMutatedDocumentKeys() {
    ...
    MutableDocument doc3 = doc("rooms/eros/messages/2", 0, map()).setHasLocalMutations();
