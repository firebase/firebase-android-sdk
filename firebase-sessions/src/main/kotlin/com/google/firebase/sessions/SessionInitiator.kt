...
internal class SessionInitiator(
  ...
  internal val activityLifecycleCallbacks =
    object : ActivityLifecycleCallbacks {
      override fun onActivityResumed(activity: Activity) = SessionLifecycleClient.foregrounded(activity)

      override fun onActivityPaused(activity: Activity) = SessionLifecycleClient.backgrounded(activity)
