...
@Deprecated("Use `com.google.firebase.Firebase.app`", ReplaceWith("com.google.firebase.Firebase.app"))
val Firebase.app: FirebaseApp
  get() = FirebaseApp.getInstance()

/** Returns a named firebase app instance. */
@Deprecated("Use `com.google.firebase.Firebase.app(name)`", ReplaceWith("com.google.firebase.Firebase.app(name)"))
fun Firebase.app(name: String): FirebaseApp = FirebaseApp.getInstance(name)

/** Initializes and returns a FirebaseApp. */
@Deprecated("Use `com.google.firebase.Firebase.initialize(context)`", ReplaceWith("com.google.firebase.Firebase.initialize(context)"))
fun Firebase.initialize(context: Context): FirebaseApp? = FirebaseApp.initializeApp(context)

/** Initializes and returns a FirebaseApp. */
@Deprecated("Use `com.google.firebase.Firebase.initialize(context, options)`", ReplaceWith("com.google.firebase.Firebase.initialize(context, options)"))
fun Firebase.initialize(context: Context, options: FirebaseOptions): FirebaseApp =
  FirebaseApp.initializeApp(context, options)

/** Initializes and returns a FirebaseApp. */
@Deprecated("Use `com.google.firebase.Firebase.initialize(context, options, name)`", ReplaceWith("com.google.firebase.Firebase.initialize(context, options, name)"))
...
@Deprecated("Use `com.google.firebase.Firebase.options`", ReplaceWith("com.google.firebase.Firebase.options"))
...
/** @suppress */
@Deprecated("Use `com.google.firebase.FirebaseCommonKtxRegistrar`", ReplaceWith("com.google.firebase.FirebaseCommonKtxRegistrar"))
@Keep
