...
- [unchanged] Updated to accommodate the release of the updated [appdistro]
  library.
...
- [changed] Added Kotlin extensions (KTX) APIs from
  ...
  `com.google.firebase.appdistribution` package. For details, see the [FAQ
  about this
  initiative](https://firebase.google.com/docs/android/kotlin-migration)
- [deprecated] All the APIs from
  `com.google.firebase:firebase-appdistribution-api-ktx` have been added to
  `com.google.firebase:firebase-appdistribution-api` under the
  `com.google.firebase.appdistribution` package, and all the Kotlin extensions
  (KTX) APIs in `com.google.firebase:firebase-appdistribution-api-ktx` are now
...
- [feature] Improved development mode to allow all API calls to be made without
  having to sign in.
...
- [feature] Added support for in-app tester feedback. To learn more, see
  ...
  testers](/docs/app-distribution/collect-feedback-from-testers?platform=android).
...
- [feature] Firebase now supports Kotlin coroutines. With this release, we
  ...
  .external} to `firebase-appdistribution-api-ktx` as a transitive dependency,
