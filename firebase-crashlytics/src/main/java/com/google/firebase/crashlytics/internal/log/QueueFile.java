...
//
// Modifications are Copyright 2018 Google LLC.
//
/*
...
class QueueFile implements Closeable {
  ...
  /**
   * Returns whether the current used data size, plus the data size provided, plus element header
   * size will stay within the max size provided
   */
