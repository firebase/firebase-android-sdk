...
public class BreadcrumbAnalyticsReceiverTest {

  @Mock private BreadcrumbHandler mockBreadcrumbHandler;

  private BreadcrumbAnalyticsReceiver receiver;

  @Before
  public void setUp() throws Exception {
    MockitoAnnotations.initMocks(this);

    receiver = new BreadcrumbAnalyticsReceiver();
  }
  ...
  public void testReceiverPassesSerializedBreadcrumbToHandler() {
    ...
    Mockito.verify(mockBreadcrumbHandler, Mockito.times(1))
        .dropBreadcrumb(argumentCaptor.capture());
