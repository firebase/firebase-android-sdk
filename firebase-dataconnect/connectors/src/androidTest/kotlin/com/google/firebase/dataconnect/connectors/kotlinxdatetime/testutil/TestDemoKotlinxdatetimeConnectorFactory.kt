...
////////////////////////////////////////////////////////////////////////////////
package com.google.firebase.dataconnect.connectors.kotlinxdatetime.testutil

import com.google.firebase.FirebaseApp
import com.google.firebase.dataconnect.DataConnectSettings
import com.google.firebase.dataconnect.FirebaseDataConnect
import com.google.firebase.dataconnect.connectors.kotlinxdatetime.DemoKotlinxdatetimeConnector
import com.google.firebase.dataconnect.connectors.kotlinxdatetime.getInstance
...
/**
 * A JUnit test rule that creates instances of [DemoKotlinxdatetimeConnector] for use during
...
// ./gradlew generateDataConnectTestingSources
////////////////////////////////////////////////////////////////////////////////
class DemoKotlinxdatetimeConnectorFactory(
  firebaseAppFactory: TestFirebaseAppFactory,
  dataConnectFactory: TestDataConnectFactory
) : TestConnectorFactory<DemoKotlinxdatetimeConnector>(firebaseAppFactory, dataConnectFactory) {
  override fun createConnector(firebaseApp: FirebaseApp, settings: DataConnectSettings) =
    DemoKotlinxdatetimeConnector.getInstance(firebaseApp, settings)
}
