...
abstract class DemoDataconnectdatetimeConnectorIntegrationTestBase :
  ...
  val connectorFactory =
    TestDemoDataconnectdatetimeConnectorFactory(firebaseAppFactory, dataConnectFactory)

  val connector: DemoDataconnectdatetimeConnector by lazy { connectorFactory.newInstance() }
}
