...
import com.google.firebase.dataconnect.connectors.dataconnectdatetime.getInstance
...
) : TestConnectorFactory<DemoDataconnectdatetimeConnector>(firebaseAppFactory, dataConnectFactory) {
  override fun createConnector(firebaseApp: FirebaseApp, settings: DataConnectSettings) =
    DemoDataconnectdatetimeConnector.getInstance(firebaseApp, settings)
}
