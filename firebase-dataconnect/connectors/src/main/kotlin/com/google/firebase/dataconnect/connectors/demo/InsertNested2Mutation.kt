...
public interface InsertNested2Mutation :
    GeneratedMutation<
      DemoConnector,
      InsertNested2Mutation.Data,
      InsertNested2Mutation.Variables
    >
{
  ...
  public data class Variables(
    ...
    String
      ...
      public companion object {
        ...
        public fun build(
          nested3: Nested3Key,value: String,
          block_: Builder.() -> Unit
        ): Variables {
          var nested3= nested3
          ...
          return object : Builder {
            override var nested3: Nested3Key
              ...
              set(value_) { nested3 = value_ }
              
            override var nested3NullableNonNull: Nested3Key?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { nested3NullableNonNull = OptionalVariable.Value(value_) }
              
            override var nested3NullableNull: Nested3Key?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { nested3NullableNull = OptionalVariable.Value(value_) }
          ...
          .let {
            Variables(
              nested3=nested3,nested3NullableNonNull=nested3NullableNonNull,nested3NullableNull=nested3NullableNull,value=value,
            )
          }
        }
      }
  ...
  public companion object {
    ...
    public const val operationName: String = "InsertNested2"
...
public fun InsertNested2Mutation.ref(
  ...
  ref(
      ...
      InsertNested2Mutation.Variables.build(
        nested3=nested3,value=value,
