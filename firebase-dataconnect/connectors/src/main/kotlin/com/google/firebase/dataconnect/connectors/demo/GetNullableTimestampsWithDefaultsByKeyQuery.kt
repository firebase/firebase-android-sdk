...
public interface GetNullableTimestampsWithDefaultsByKeyQuery :
  ...
  @Serializable public data class Variables(val key: NullableTimestampsWithDefaultsKey) {}

  @Serializable
  public data class Data(val nullableTimestampsWithDefaults: NullableTimestampsWithDefaults?) {
