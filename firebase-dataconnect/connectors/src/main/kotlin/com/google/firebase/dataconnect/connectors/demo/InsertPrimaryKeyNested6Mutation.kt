...
public interface InsertPrimaryKeyNested6Mutation :
    GeneratedMutation<
      DemoConnector,
      InsertPrimaryKeyNested6Mutation.Data,
    ...
    >
{
  ...
  public data class Variables(
    ...
    String,
    val nested3:
    PrimaryKeyNested3Key,
    val nested4:
    PrimaryKeyNested4Key
  ) {
  ...
  @SerialName("primaryKeyNested6_insert")
    val key:
...
public fun InsertPrimaryKeyNested6Mutation.ref(
    ...
    value: String,nested3: PrimaryKeyNested3Key,nested4: PrimaryKeyNested4Key,
  ...
  ref(
      ...
      InsertPrimaryKeyNested6Mutation.Variables(
        value=value,nested3=nested3,nested4=nested4,
