...
public interface GetNullableDatesWithDefaultsByKeyQuery :
  ...
  @Serializable public data class Variables(val key: NullableDatesWithDefaultsKey) {}

  @Serializable
  public data class Data(val nullableDatesWithDefaults: NullableDatesWithDefaults?) {

    @Serializable
    public data class NullableDatesWithDefaults(
      val valueWithVariableDefault: java.util.Date?,
      val valueWithSchemaDefault: java.util.Date?,
      val epoch: java.util.Date?,
      val requestTime1: java.util.Date?,
      val requestTime2: java.util.Date?
    ) {}
  }
...
public fun GetNullableDatesWithDefaultsByKeyQuery.ref(
  ...
  GetNullableDatesWithDefaultsByKeyQuery.Data, GetNullableDatesWithDefaultsByKeyQuery.Variables
> =
  ref(
    GetNullableDatesWithDefaultsByKeyQuery.Variables(
      key = key,
