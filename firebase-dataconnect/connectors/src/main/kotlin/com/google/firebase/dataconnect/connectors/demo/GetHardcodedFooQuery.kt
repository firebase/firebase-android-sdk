    ...
    >
{
  ...
  public companion object {
    ...
    public const val operationName: String = "GetHardcodedFoo"
    public val dataDeserializer: DeserializationStrategy<Data> = serializer()
    public val variablesSerializer: SerializationStrategy<Unit> = serializer()
  }
}

public fun GetHardcodedFooQuery.ref(
...
public suspend fun GetHardcodedFooQuery.execute(
  ...
  public fun GetHardcodedFooQuery.flow(
    ...
    ): Flow<GetHardcodedFooQuery.Data> =
    ref(
