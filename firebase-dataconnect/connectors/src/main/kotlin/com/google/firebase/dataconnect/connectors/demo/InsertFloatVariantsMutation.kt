...
public interface InsertFloatVariantsMutation :
  GeneratedMutation<
    DemoConnector, InsertFloatVariantsMutation.Data, InsertFloatVariantsMutation.Variables
  > {
  ...
  public data class Variables(
    ...
    public companion object {
      ...
      public fun build(
        nonNullWithZeroValue: Double,
        nonNullWithNegativeZeroValue: Double,
        nonNullWithPositiveValue: Double,
        nonNullWithNegativeValue: Double,
        nonNullWithMaxValue: Double,
        nonNullWithMinValue: Double,
        nonNullWithMaxSafeIntegerValue: Double,
        block_: Builder.() -> Unit
      ): Variables {
        ...
        return object : Builder {
            ...
            override var nonNullWithNegativeZeroValue: Double
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) {
                nonNullWithNegativeZeroValue = value_
              }
            ...
            override var nonNullWithMaxSafeIntegerValue: Double
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) {
                nonNullWithMaxSafeIntegerValue = value_
              }
  ...
  public companion object {
    @Suppress("ConstPropertyName") public const val operationName: String = "InsertFloatVariants"
...
): MutationRef<InsertFloatVariantsMutation.Data, InsertFloatVariantsMutation.Variables> =
  ref(
...
public suspend fun InsertFloatVariantsMutation.execute(
  ...
  nonNullWithMaxSafeIntegerValue: Double,
  block_: InsertFloatVariantsMutation.Variables.Builder.() -> Unit
): MutationResult<InsertFloatVariantsMutation.Data, InsertFloatVariantsMutation.Variables> =
  ref(
      nonNullWithZeroValue = nonNullWithZeroValue,
      nonNullWithNegativeZeroValue = nonNullWithNegativeZeroValue,
      nonNullWithPositiveValue = nonNullWithPositiveValue,
