...
public interface GetPrimaryKeyIsStringByKeyQuery :
    GeneratedQuery<
      DemoConnector,
      GetPrimaryKeyIsStringByKeyQuery.Data,
    ...
    >
{
  ...
  public data class Data(
    ...
    val primaryKeyIsString:
    PrimaryKeyIsString?
  ) {
    
      
        @Serializable
  public data class PrimaryKeyIsString(
...
public suspend fun GetPrimaryKeyIsStringByKeyQuery.execute(
  ...
  public fun GetPrimaryKeyIsStringByKeyQuery.flow(
    ...
    ): Flow<GetPrimaryKeyIsStringByKeyQuery.Data> =
    ref(
