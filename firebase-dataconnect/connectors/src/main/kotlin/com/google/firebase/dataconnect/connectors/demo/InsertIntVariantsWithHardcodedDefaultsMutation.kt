...
public interface InsertIntVariantsWithHardcodedDefaultsMutation :
    GeneratedMutation<
      DemoConnector,
      InsertIntVariantsWithHardcodedDefaultsMutation.Data,
      InsertIntVariantsWithHardcodedDefaultsMutation.Variables
    >
{
  ...
  public companion object {
    ...
    public const val operationName: String = "InsertIntVariantsWithHardcodedDefaults"
    public val dataDeserializer: DeserializationStrategy<Data> = serializer()
    public val variablesSerializer: SerializationStrategy<Variables> = serializer()
  }
}

public fun InsertIntVariantsWithHardcodedDefaultsMutation.ref(
  
    
  
    block_: InsertIntVariantsWithHardcodedDefaultsMutation.Variables.Builder.() -> Unit
  ...
  ref(
      ...
      InsertIntVariantsWithHardcodedDefaultsMutation.Variables.build(
...
public suspend fun InsertIntVariantsWithHardcodedDefaultsMutation.execute(
