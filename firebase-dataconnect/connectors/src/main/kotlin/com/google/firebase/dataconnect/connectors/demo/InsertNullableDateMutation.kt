...
public interface InsertNullableDateMutation :
    GeneratedMutation<
      DemoConnector,
      InsertNullableDateMutation.Data,
      InsertNullableDateMutation.Variables
    >
{
  ...
  @SerialName("nullableDate_insert")
    val key:
    NullableDateKey
  ) {
  ...
  public companion object {
    ...
    public const val operationName: String = "InsertNullableDate"
...
public fun InsertNullableDateMutation.ref(
  ...
  ref(
      ...
      InsertNullableDateMutation.Variables.build(
