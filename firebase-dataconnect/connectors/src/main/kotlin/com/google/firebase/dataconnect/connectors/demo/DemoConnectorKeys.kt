...
@Serializable public data class BooleanVariantsKey(val id: java.util.UUID) {}

@Serializable public data class FloatVariantsKey(val id: java.util.UUID) {}

@Serializable public data class FooKey(val id: String) {}

@Serializable public data class Int64variantsKey(val id: java.util.UUID) {}

@Serializable public data class IntVariantsKey(val id: java.util.UUID) {}
...
@Serializable public data class NonNullDateKey(val id: java.util.UUID) {}

@Serializable public data class NonNullDatesWithDefaultsKey(val id: java.util.UUID) {}

@Serializable public data class NonNullTimestampKey(val id: java.util.UUID) {}

@Serializable public data class NonNullTimestampsWithDefaultsKey(val id: java.util.UUID) {}

@Serializable public data class NonNullableListsKey(val id: java.util.UUID) {}

@Serializable public data class NullableDateKey(val id: java.util.UUID) {}

@Serializable public data class NullableDatesWithDefaultsKey(val id: java.util.UUID) {}

@Serializable public data class NullableListsKey(val id: java.util.UUID) {}

@Serializable public data class NullableTimestampKey(val id: java.util.UUID) {}

@Serializable public data class NullableTimestampsWithDefaultsKey(val id: java.util.UUID) {}
...
@Serializable public data class StringVariantsKey(val id: java.util.UUID) {}

@Serializable public data class SyntheticIdKey(val id: java.util.UUID) {}

@Serializable public data class UuidVariantsKey(val id: java.util.UUID) {}
