...
public interface InsertPrimaryKeyIsUuidMutation :
    GeneratedMutation<
      DemoConnector,
      InsertPrimaryKeyIsUuidMutation.Data,
    ...
    >
{
  ...
  @SerialName("primaryKeyIsUUID_insert")
    val key:
    PrimaryKeyIsUuidKey
  ) {
  ...
  public companion object {
    ...
    public const val operationName: String = "InsertPrimaryKeyIsUUID"
...
public fun InsertPrimaryKeyIsUuidMutation.ref(
    ...
    id: java.util.UUID,value: String,
