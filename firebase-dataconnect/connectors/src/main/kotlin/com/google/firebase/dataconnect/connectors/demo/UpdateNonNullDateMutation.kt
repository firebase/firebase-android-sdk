...
public interface UpdateNonNullDateMutation :
    GeneratedMutation<
      DemoConnector,
      UpdateNonNullDateMutation.Data,
      UpdateNonNullDateMutation.Variables
    >
{
  ...
  public companion object {
    ...
    public const val operationName: String = "UpdateNonNullDate"
...
public fun UpdateNonNullDateMutation.ref(
  ...
  ref(
      ...
      UpdateNonNullDateMutation.Variables.build(
        key=key,
