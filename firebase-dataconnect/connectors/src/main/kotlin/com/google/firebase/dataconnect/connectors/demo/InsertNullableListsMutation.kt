...
public interface InsertNullableListsMutation :
  GeneratedMutation<
    DemoConnector, InsertNullableListsMutation.Data, InsertNullableListsMutation.Variables
  > {
  ...
  @Serializable
  public data class Data(@SerialName("nullableLists_insert") val key: NullableListsKey) {}

  public companion object {
    @Suppress("ConstPropertyName") public const val operationName: String = "InsertNullableLists"
    public val dataDeserializer: DeserializationStrategy<Data> = serializer()
    public val variablesSerializer: SerializationStrategy<Variables> = serializer()
  }
}

public fun InsertNullableListsMutation.ref(
  block_: InsertNullableListsMutation.Variables.Builder.() -> Unit
): MutationRef<InsertNullableListsMutation.Data, InsertNullableListsMutation.Variables> =
  ref(InsertNullableListsMutation.Variables.build(block_))

public suspend fun InsertNullableListsMutation.execute(
  block_: InsertNullableListsMutation.Variables.Builder.() -> Unit
): MutationResult<InsertNullableListsMutation.Data, InsertNullableListsMutation.Variables> =
  ref(block_).execute()
