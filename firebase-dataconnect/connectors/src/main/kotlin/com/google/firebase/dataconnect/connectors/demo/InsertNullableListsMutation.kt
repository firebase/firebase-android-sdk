...
public interface InsertNullableListsMutation :
    GeneratedMutation<
      DemoConnector,
      InsertNullableListsMutation.Data,
      InsertNullableListsMutation.Variables
    >
{
    ...
    OptionalVariable<List<com.google.firebase.Timestamp>?>
      ...
      public companion object {
        ...
        public fun build(
          ...
          .let {
            Variables(
              strings=strings,ints=ints,floats=floats,booleans=booleans,uuids=uuids,int64s=int64s,dates=dates,timestamps=timestamps,
            )
          }
        }
      }
  ...
  @SerialName("nullableLists_insert")
    val key:
    NullableListsKey
  ) {
  ...
  public companion object {
    ...
    public const val operationName: String = "InsertNullableLists"
...
public fun InsertNullableListsMutation.ref(
  ...
  ref(
      ...
      InsertNullableListsMutation.Variables.build(
