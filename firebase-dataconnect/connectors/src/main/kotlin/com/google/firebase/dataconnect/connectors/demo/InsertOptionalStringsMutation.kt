...
public interface InsertOptionalStringsMutation :
    GeneratedMutation<
      DemoConnector,
      InsertOptionalStringsMutation.Data,
      InsertOptionalStringsMutation.Variables
    >
{
  ...
  public data class Variables(
    ...
    OptionalVariable<String?>
      ...
      public companion object {
        ...
        public fun build(
          required1: String,required2: String,
          block_: Builder.() -> Unit
        ): Variables {
          ...
          return object : Builder {
            override var required1: String
              ...
              set(value_) { required1 = value_ }
              
            override var required2: String
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { required2 = value_ }
              
            override var nullable1: String?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { nullable1 = OptionalVariable.Value(value_) }
              
            override var nullable2: String?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { nullable2 = OptionalVariable.Value(value_) }
              
            override var nullable3: String?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { nullable3 = OptionalVariable.Value(value_) }
              
            override var nullableWithSchemaDefault: String?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { nullableWithSchemaDefault = OptionalVariable.Value(value_) }
              
            
          }.apply(block_)
          .let {
            Variables(
              required1=required1,required2=required2,nullable1=nullable1,nullable2=nullable2,nullable3=nullable3,nullableWithSchemaDefault=nullableWithSchemaDefault,
            )
          }
        }
      }
  ...
  @SerialName("optionalStrings_insert")
    val key:
    OptionalStringsKey
  ) {
  ...
  public companion object {
    ...
    public const val operationName: String = "InsertOptionalStrings"
...
public fun InsertOptionalStringsMutation.ref(
  ...
  ref(
      ...
      InsertOptionalStringsMutation.Variables.build(
        required1=required1,required2=required2,
