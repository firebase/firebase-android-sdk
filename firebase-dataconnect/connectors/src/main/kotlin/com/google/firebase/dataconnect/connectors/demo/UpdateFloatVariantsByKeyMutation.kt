...
public interface UpdateFloatVariantsByKeyMutation :
  GeneratedMutation<
    DemoConnector, UpdateFloatVariantsByKeyMutation.Data, UpdateFloatVariantsByKeyMutation.Variables
  > {

  @Serializable
  public data class Variables(
    val key: FloatVariantsKey,
    ...
    public companion object {
      ...
      public fun build(key: FloatVariantsKey, block_: Builder.() -> Unit): Variables {
        var key = key
  ...
  @Serializable
  public data class Data(@SerialName("floatVariants_update") val key: FloatVariantsKey?) {}
...
): MutationRef<UpdateFloatVariantsByKeyMutation.Data, UpdateFloatVariantsByKeyMutation.Variables> =
  ref(UpdateFloatVariantsByKeyMutation.Variables.build(key = key, block_))

public suspend fun UpdateFloatVariantsByKeyMutation.execute(
  key: FloatVariantsKey,
  block_: UpdateFloatVariantsByKeyMutation.Variables.Builder.() -> Unit
): MutationResult<
  UpdateFloatVariantsByKeyMutation.Data, UpdateFloatVariantsByKeyMutation.Variables
