...
public interface GetStringVariantsByKeyQuery :
  GeneratedQuery<
    DemoConnector, GetStringVariantsByKeyQuery.Data, GetStringVariantsByKeyQuery.Variables
  > {

  @Serializable public data class Variables(val key: StringVariantsKey) {}
  ...
  public companion object {
    @Suppress("ConstPropertyName") public const val operationName: String = "GetStringVariantsByKey"
...
): QueryRef<GetStringVariantsByKeyQuery.Data, GetStringVariantsByKeyQuery.Variables> =
  ref(
...
public suspend fun GetStringVariantsByKeyQuery.execute(
  key: StringVariantsKey,
): QueryResult<GetStringVariantsByKeyQuery.Data, GetStringVariantsByKeyQuery.Variables> =
  ref(
      key = key,
    )
    .execute()
