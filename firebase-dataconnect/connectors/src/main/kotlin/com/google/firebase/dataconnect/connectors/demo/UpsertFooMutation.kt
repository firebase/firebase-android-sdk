...
public interface UpsertFooMutation :
    GeneratedMutation<
      DemoConnector,
      UpsertFooMutation.Data,
      UpsertFooMutation.Variables
    >
{
  ...
  public companion object {
    ...
    public const val operationName: String = "UpsertFoo"
...
public fun UpsertFooMutation.ref(
  ...
  ref(
      ...
      UpsertFooMutation.Variables.build(
        id=id,
