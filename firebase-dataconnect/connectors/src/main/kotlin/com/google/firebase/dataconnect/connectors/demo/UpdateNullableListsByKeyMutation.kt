...
public interface UpdateNullableListsByKeyMutation :
  GeneratedMutation<
    DemoConnector, UpdateNullableListsByKeyMutation.Data, UpdateNullableListsByKeyMutation.Variables
  > {

  @Serializable
  public data class Variables(
    val key: NullableListsKey,
    ...
    public companion object {
      ...
      public fun build(key: NullableListsKey, block_: Builder.() -> Unit): Variables {
        var key = key
  ...
  @Serializable
  public data class Data(@SerialName("nullableLists_update") val key: NullableListsKey?) {}
...
): MutationRef<UpdateNullableListsByKeyMutation.Data, UpdateNullableListsByKeyMutation.Variables> =
  ref(UpdateNullableListsByKeyMutation.Variables.build(key = key, block_))

public suspend fun UpdateNullableListsByKeyMutation.execute(
  key: NullableListsKey,
  block_: UpdateNullableListsByKeyMutation.Variables.Builder.() -> Unit
): MutationResult<
  UpdateNullableListsByKeyMutation.Data, UpdateNullableListsByKeyMutation.Variables
