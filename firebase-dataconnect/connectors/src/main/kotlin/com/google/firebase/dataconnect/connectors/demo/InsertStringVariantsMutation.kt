...
public interface InsertStringVariantsMutation :
    GeneratedMutation<
      DemoConnector,
      InsertStringVariantsMutation.Data,
    ...
    >
{
  ...
  public data class Variables(
    ...
    OptionalVariable<String?>
      ...
      public companion object {
        ...
        public fun build(
          nonNullWithNonEmptyValue: String,nonNullWithEmptyValue: String,
          block_: Builder.() -> Unit
        ): Variables {
          ...
          return object : Builder {
            override var nonNullWithNonEmptyValue: String
              ...
              set(value_) { nonNullWithNonEmptyValue = value_ }
              
            override var nonNullWithEmptyValue: String
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { nonNullWithEmptyValue = value_ }
  ...
  public companion object {
    ...
    public const val operationName: String = "InsertStringVariants"
...
public fun InsertStringVariantsMutation.ref(
  ...
  ref(
      ...
      InsertStringVariantsMutation.Variables.build(
        nonNullWithNonEmptyValue=nonNullWithNonEmptyValue,nonNullWithEmptyValue=nonNullWithEmptyValue,
