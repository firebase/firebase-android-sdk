...
public interface InsertTwoFoosMutation :
  ...
  public data class Variables(
    val id1: String,
    val id2: String,
    val bar1: OptionalVariable<String?>,
    val bar2: OptionalVariable<String?>
  ) {
    ...
    public companion object {
      ...
      public fun build(id1: String, id2: String, block_: Builder.() -> Unit): Variables {
        var id1 = id1
        var id2 = id2
        ...
        return object : Builder {
            ...
            override var bar1: String?
              get() = bar1.valueOrNull()
              set(value_) {
                bar1 = OptionalVariable.Value(value_)
              }

            override var bar2: String?
              get() = bar2.valueOrNull()
              set(value_) {
                bar2 = OptionalVariable.Value(value_)
              }
          }
          .apply(block_)
          .let {
...
public fun InsertTwoFoosMutation.ref(
  ...
  ref(InsertTwoFoosMutation.Variables.build(id1 = id1, id2 = id2, block_))
...
public suspend fun InsertTwoFoosMutation.execute(
  ...
  ref(id1 = id1, id2 = id2, block_).execute()
