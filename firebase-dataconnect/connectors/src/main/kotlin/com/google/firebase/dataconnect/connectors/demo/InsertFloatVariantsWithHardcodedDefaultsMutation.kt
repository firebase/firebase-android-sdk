...
public interface InsertFloatVariantsWithHardcodedDefaultsMutation :
  GeneratedMutation<
    DemoConnector,
    InsertFloatVariantsWithHardcodedDefaultsMutation.Data,
    InsertFloatVariantsWithHardcodedDefaultsMutation.Variables
  > {

  @Serializable
  public data class Variables(
    val nonNullWithZeroValue: OptionalVariable<Double>,
    val nonNullWithNegativeZeroValue: OptionalVariable<Double>,
    val nonNullWithPositiveValue: OptionalVariable<Double>,
    val nonNullWithNegativeValue: OptionalVariable<Double>,
    val nonNullWithMaxValue: OptionalVariable<Double>,
    val nonNullWithMinValue: OptionalVariable<Double>,
    val nonNullWithMaxSafeIntegerValue: OptionalVariable<Double>,
    val nullableWithNullValue: OptionalVariable<Double?>,
    val nullableWithZeroValue: OptionalVariable<Double?>,
    val nullableWithNegativeZeroValue: OptionalVariable<Double?>,
    val nullableWithPositiveValue: OptionalVariable<Double?>,
    val nullableWithNegativeValue: OptionalVariable<Double?>,
    val nullableWithMaxValue: OptionalVariable<Double?>,
    val nullableWithMinValue: OptionalVariable<Double?>,
    val nullableWithMaxSafeIntegerValue: OptionalVariable<Double?>
  ) {
      ...
      public fun build(block_: Builder.() -> Unit): Variables {
        ...
        return object : Builder {
            ...
            override var nonNullWithNegativeZeroValue: Double
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) {
                nonNullWithNegativeZeroValue = OptionalVariable.Value(value_)
              }
            ...
            override var nonNullWithMaxSafeIntegerValue: Double
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) {
                nonNullWithMaxSafeIntegerValue = OptionalVariable.Value(value_)
              }
            ...
            override var nullableWithNegativeZeroValue: Double?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) {
                nullableWithNegativeZeroValue = OptionalVariable.Value(value_)
              }
            ...
            override var nullableWithMaxSafeIntegerValue: Double?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) {
                nullableWithMaxSafeIntegerValue = OptionalVariable.Value(value_)
              }
          }
          .apply(block_)
          .let {
  ...
  @Serializable
  public data class Data(@SerialName("floatVariants_insert") val key: FloatVariantsKey) {}

  public companion object {
    @Suppress("ConstPropertyName")
    public const val operationName: String = "InsertFloatVariantsWithHardcodedDefaults"
    public val dataDeserializer: DeserializationStrategy<Data> = serializer()
    public val variablesSerializer: SerializationStrategy<Variables> = serializer()
  }
}

public fun InsertFloatVariantsWithHardcodedDefaultsMutation.ref(
  block_: InsertFloatVariantsWithHardcodedDefaultsMutation.Variables.Builder.() -> Unit
): MutationRef<
  InsertFloatVariantsWithHardcodedDefaultsMutation.Data,
  InsertFloatVariantsWithHardcodedDefaultsMutation.Variables
> = ref(InsertFloatVariantsWithHardcodedDefaultsMutation.Variables.build(block_))

public suspend fun InsertFloatVariantsWithHardcodedDefaultsMutation.execute(
  block_: InsertFloatVariantsWithHardcodedDefaultsMutation.Variables.Builder.() -> Unit
): MutationResult<
  InsertFloatVariantsWithHardcodedDefaultsMutation.Data,
  InsertFloatVariantsWithHardcodedDefaultsMutation.Variables
