...
public interface GetNested1byKeyQuery :
  ...
  public data class Data(val nested1: Nested1?) {
    ...
    public data class Nested1(
      ...
      val nested2NullableNull: Nested2nullableNull?
    ) {
      ...
      public data class Nested1(
        ...
        public data class Nested2(
          ...
          val value: String,
          val nested3: Nested3,
          val nested3NullableNull: Nested3nullableNull?,
  ...
  public companion object {
    @Suppress("ConstPropertyName") public const val operationName: String = "GetNested1ByKey"
