...
public interface UpdateStringVariantsByKeyMutation :
  GeneratedMutation<
    DemoConnector,
    UpdateStringVariantsByKeyMutation.Data,
    UpdateStringVariantsByKeyMutation.Variables
  > {

  @Serializable
  public data class Variables(
    val key: StringVariantsKey,
    val nonNullWithNonEmptyValue: OptionalVariable<String?>,
    val nonNullWithEmptyValue: OptionalVariable<String?>,
    ...
    public interface Builder {
      public var key: StringVariantsKey
    ...
    public companion object {
      ...
      public fun build(key: StringVariantsKey, block_: Builder.() -> Unit): Variables {
        var key = key
        ...
        return object : Builder {
            override var key: StringVariantsKey
            ...
            override var nonNullWithNonEmptyValue: String?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) {
                nonNullWithNonEmptyValue = OptionalVariable.Value(value_)
              }

            override var nonNullWithEmptyValue: String?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) {
                nonNullWithEmptyValue = OptionalVariable.Value(value_)
              }
  ...
  @Serializable
  public data class Data(@SerialName("stringVariants_update") val key: StringVariantsKey?) {}

  public companion object {
    @Suppress("ConstPropertyName")
    public const val operationName: String = "UpdateStringVariantsByKey"
    public val dataDeserializer: DeserializationStrategy<Data> = serializer()
    public val variablesSerializer: SerializationStrategy<Variables> = serializer()
  }
}

public fun UpdateStringVariantsByKeyMutation.ref(
  key: StringVariantsKey,
  block_: UpdateStringVariantsByKeyMutation.Variables.Builder.() -> Unit
): MutationRef<
  UpdateStringVariantsByKeyMutation.Data, UpdateStringVariantsByKeyMutation.Variables
> = ref(UpdateStringVariantsByKeyMutation.Variables.build(key = key, block_))

public suspend fun UpdateStringVariantsByKeyMutation.execute(
  key: StringVariantsKey,
  block_: UpdateStringVariantsByKeyMutation.Variables.Builder.() -> Unit
): MutationResult<
  UpdateStringVariantsByKeyMutation.Data, UpdateStringVariantsByKeyMutation.Variables
