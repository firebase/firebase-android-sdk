    ...
    >
{
    ...
    OptionalVariable<String?>
      ...
      public companion object {
        ...
        public fun build(
          ...
          .let {
            Variables(
              key=key,nonNullWithNonEmptyValue=nonNullWithNonEmptyValue,nonNullWithEmptyValue=nonNullWithEmptyValue,nullableWithNullValue=nullableWithNullValue,nullableWithNonNullValue=nullableWithNonNullValue,nullableWithEmptyValue=nullableWithEmptyValue,
            )
          }
        }
      }
  ...
  @SerialName("stringVariants_update")
    val key:
    StringVariantsKey?
  ) {
...
public fun UpdateStringVariantsByKeyMutation.ref(
  ...
  ref(
      ...
      UpdateStringVariantsByKeyMutation.Variables.build(
        key=key,
