...
public interface InsertUuidVariantsMutation :
    GeneratedMutation<
      DemoConnector,
      InsertUuidVariantsMutation.Data,
    ...
    >
{
        ...
        public fun build(
          ...
          return object : Builder {
            override var nonNullValue: java.util.UUID
              ...
              set(value_) { nonNullValue = value_ }
          ...
          .let {
            Variables(
              nonNullValue=nonNullValue,nullableWithNullValue=nullableWithNullValue,nullableWithNonNullValue=nullableWithNonNullValue,
            )
          }
        }
      }
  ...
  @SerialName("uUIDVariants_insert")
    val key:
    UuidVariantsKey
  ) {
  ...
  public companion object {
    ...
    public const val operationName: String = "InsertUUIDVariants"
