...
public interface UpdateIntVariantsByKeyMutation :
    GeneratedMutation<
      DemoConnector,
      UpdateIntVariantsByKeyMutation.Data,
      UpdateIntVariantsByKeyMutation.Variables
    >
{
  ...
  public companion object {
    ...
    public const val operationName: String = "UpdateIntVariantsByKey"
...
public fun UpdateIntVariantsByKeyMutation.ref(
  ...
  ref(
      ...
      UpdateIntVariantsByKeyMutation.Variables.build(
        key=key,
