    ...
    >
{
    ...
    OptionalVariable<Boolean?>
      ...
      public companion object {
        ...
        public fun build(
          ...
          .let {
            Variables(
              key=key,nonNullWithTrueValue=nonNullWithTrueValue,nonNullWithFalseValue=nonNullWithFalseValue,nullableWithNullValue=nullableWithNullValue,nullableWithTrueValue=nullableWithTrueValue,nullableWithFalseValue=nullableWithFalseValue,
            )
          }
        }
      }
  ...
  @SerialName("booleanVariants_update")
    val key:
    BooleanVariantsKey?
  ) {
...
public fun UpdateBooleanVariantsByKeyMutation.ref(
  ...
  ref(
      ...
      UpdateBooleanVariantsByKeyMutation.Variables.build(
        key=key,
