...
public interface UpdateUuidVariantsByKeyMutation :
    GeneratedMutation<
      DemoConnector,
      UpdateUuidVariantsByKeyMutation.Data,
      UpdateUuidVariantsByKeyMutation.Variables
    >
{
        ...
        public fun build(
          ...
          return object : Builder {
            ...
            override var nonNullValue: java.util.UUID?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { nonNullValue = OptionalVariable.Value(value_) }
          ...
          .let {
            Variables(
              key=key,nonNullValue=nonNullValue,nullableWithNullValue=nullableWithNullValue,nullableWithNonNullValue=nullableWithNonNullValue,
            )
          }
        }
      }
  ...
  @SerialName("uUIDVariants_update")
    val key:
    UuidVariantsKey?
  ) {
...
public fun UpdateUuidVariantsByKeyMutation.ref(
  ...
  ref(
      ...
      UpdateUuidVariantsByKeyMutation.Variables.build(
        key=key,
