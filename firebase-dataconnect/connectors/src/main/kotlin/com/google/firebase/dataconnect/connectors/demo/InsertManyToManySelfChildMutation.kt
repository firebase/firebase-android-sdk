...
public interface InsertManyToManySelfChildMutation :
  ...
  @Serializable
  public data class Data(@SerialName("manyToManySelfChild_insert") val key: ManyToManySelfChildKey)

  public companion object {
    @Suppress("ConstPropertyName")
    public const val operationName: String = "InsertManyToManySelfChild"
