    ...
    >
{
  ...
  public data class Variables(
    ...
    val nested1:
    OptionalVariable<Nested1Key?>,
    val nested2:
    Nested2Key,
    val nested2NullableNonNull:
    OptionalVariable<Nested2Key?>,
    ...
    String
      ...
      public companion object {
        ...
        public fun build(
          nested2: Nested2Key,value: String,
          block_: Builder.() -> Unit
        ): Variables {
          ...
          return object : Builder {
            override var nested1: Nested1Key?
              ...
              set(value_) { nested1 = OptionalVariable.Value(value_) }
              
            override var nested2: Nested2Key
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { nested2 = value_ }
              
            override var nested2NullableNonNull: Nested2Key?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { nested2NullableNonNull = OptionalVariable.Value(value_) }
              
            override var nested2NullableNull: Nested2Key?
              get() = throw UnsupportedOperationException("getting builder values is not supported")
              set(value_) { nested2NullableNull = OptionalVariable.Value(value_) }
          ...
          .let {
            Variables(
              nested1=nested1,nested2=nested2,nested2NullableNonNull=nested2NullableNonNull,nested2NullableNull=nested2NullableNull,value=value,
            )
          }
        }
      }
  ...
  public companion object {
    ...
    public const val operationName: String = "InsertNested1"
...
public fun InsertNested1Mutation.ref(
  ...
  ref(
      ...
      InsertNested1Mutation.Variables.build(
