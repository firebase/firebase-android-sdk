...
public interface UpdateInt64variantsByKeyMutation :
    GeneratedMutation<
      DemoConnector,
      UpdateInt64variantsByKeyMutation.Data,
      UpdateInt64variantsByKeyMutation.Variables
    >
{
  ...
  @SerialName("int64Variants_update")
    val key:
    Int64variantsKey?
  ) {
...
public fun UpdateInt64variantsByKeyMutation.ref(
  ...
  ref(
      ...
      UpdateInt64variantsByKeyMutation.Variables.build(
        key=key,
