...
public interface InsertManyToOneParentMutation :
    GeneratedMutation<
      DemoConnector,
      InsertManyToOneParentMutation.Data,
      InsertManyToOneParentMutation.Variables
    >
{
  ...
  public data class Variables(
    ...
    val child:
    OptionalVariable<ManyToOneChildKey?>
  ) {
        ...
        public fun build(
          ...
          return object : Builder {
            override var child: ManyToOneChildKey?
              ...
              set(value_) { child = OptionalVariable.Value(value_) }
  ...
  @SerialName("manyToOneParent_insert")
    val key:
    ManyToOneParentKey
  ) {
  ...
  public companion object {
    ...
    public const val operationName: String = "InsertManyToOneParent"
...
public fun InsertManyToOneParentMutation.ref(
  ...
  ref(
      ...
      InsertManyToOneParentMutation.Variables.build(
