...
public interface InsertIntVariantsMutation :
    GeneratedMutation<
      DemoConnector,
      InsertIntVariantsMutation.Data,
      InsertIntVariantsMutation.Variables
    >
{
  ...
  public data class Variables(
    ...
    OptionalVariable<Int?>
      ...
      public companion object {
        ...
        public fun build(
          nonNullWithZeroValue: Int,nonNullWithPositiveValue: Int,nonNullWithNegativeValue: Int,nonNullWithMaxValue: Int,nonNullWithMinValue: Int,
          block_: Builder.() -> Unit
        ): Variables {
  ...
  public companion object {
    ...
    public const val operationName: String = "InsertIntVariants"
