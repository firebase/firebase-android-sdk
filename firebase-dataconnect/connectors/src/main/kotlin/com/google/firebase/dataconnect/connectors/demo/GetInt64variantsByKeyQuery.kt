...
public interface GetInt64variantsByKeyQuery :
  GeneratedQuery<
    DemoConnector, GetInt64variantsByKeyQuery.Data, GetInt64variantsByKeyQuery.Variables
  > {

  @Serializable public data class Variables(val key: Int64variantsKey) {}
  ...
  public companion object {
    @Suppress("ConstPropertyName") public const val operationName: String = "GetInt64VariantsByKey"
...
): QueryRef<GetInt64variantsByKeyQuery.Data, GetInt64variantsByKeyQuery.Variables> =
  ref(
...
public suspend fun GetInt64variantsByKeyQuery.execute(
  key: Int64variantsKey,
): QueryResult<GetInt64variantsByKeyQuery.Data, GetInt64variantsByKeyQuery.Variables> =
  ref(
      key = key,
    )
    .execute()
