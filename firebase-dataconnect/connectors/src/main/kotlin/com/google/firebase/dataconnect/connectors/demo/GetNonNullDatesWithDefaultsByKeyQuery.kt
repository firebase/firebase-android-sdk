...
public interface GetNonNullDatesWithDefaultsByKeyQuery :
  ...
  @Serializable public data class Variables(val key: NonNullDatesWithDefaultsKey) {}

  @Serializable
  public data class Data(val nonNullDatesWithDefaults: NonNullDatesWithDefaults?) {
...
public fun GetNonNullDatesWithDefaultsByKeyQuery.ref(
  ...
  GetNonNullDatesWithDefaultsByKeyQuery.Data, GetNonNullDatesWithDefaultsByKeyQuery.Variables
> =
  ref(
    GetNonNullDatesWithDefaultsByKeyQuery.Variables(
      key = key,
