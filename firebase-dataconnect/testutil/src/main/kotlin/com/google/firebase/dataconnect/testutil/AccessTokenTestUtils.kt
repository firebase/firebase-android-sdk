...
fun LoggedInMultiTokenAndUidAuthProvider.TokenUidPair?.toAuthTokenResult():
  com.google.firebase.auth.GetTokenResult =
  when (this) {
    null -> authTokenResultFor(null, null)
...
fun LoggedInMultiTokenAndUidAuthProvider.TokenUidPair?.toInternalTokenResult():
  InternalTokenResult = InternalTokenResult(this?.token)
