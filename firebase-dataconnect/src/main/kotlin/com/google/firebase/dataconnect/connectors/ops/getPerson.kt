...
suspend fun QueryRef<getPersonVariables, getPersonData>.execute(id: String) =
  execute(getPersonVariables(id = id))

fun QueryRef<getPersonVariables, getPersonData>.subscribe(id: String) =
  subscribe(getPersonVariables(id = id))
