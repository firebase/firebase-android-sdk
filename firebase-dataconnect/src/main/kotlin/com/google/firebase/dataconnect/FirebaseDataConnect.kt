 ...
 *
 * [FirebaseDataConnect] the entry point to the Firebase Data Connect API; however, it is mostly
 ...
 * .
 *
 * The Firebase Data Connect API is a Kotlin-only API, and integrates tightly with
 ...
 * [ConnectorConfig] will return the same instance that was returned from the previous invocation.
 *
