 ...
 * @param host The host of the Firebase Data Connect service to which to connect (e.g.
 * `"myproxy.foo.com"`, `"myproxy.foo.com:9987"`).
 * @param sslEnabled Whether to use SSL for the connection; if `true`, then the connection will be
 * encrypted using SSL and, if false, the connection will _not_ be encrypted and all network
