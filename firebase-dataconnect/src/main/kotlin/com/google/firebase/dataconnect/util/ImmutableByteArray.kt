...
internal class ImmutableByteArray private constructor(private val array: ByteArray) {
  ...
  /** Creates and returns a copy of the underlying byte array. */
  fun byteArrayCopyOf(): ByteArray = array.copyOf()

  /**
   * Returns a reference to the underlying byte array for read-only purposes.
   *
   * The caller MUST NOT make any changes to the returned byte array.
   */
  fun peek(): ByteArray = array
