...
/**
 * An implementation of [KSerializer] for serializing and deserializing [kotlinx.datetime.Instant] objects in the
 ...
 */
public object KotlinxDatetimeInstantSerializer : KSerializer<kotlinx.datetime.Instant> {
  ...
  override fun deserialize(decoder: Decoder): kotlinx.datetime.Instant {
    return TimestampSerializer.deserialize(decoder).toKotlinxInstant()
  }
}
