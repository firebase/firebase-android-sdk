...
class PostsTest {
  ...
  fun subscribe() {
    ...
    runBlocking {
      ...
      assertWithMessage("result1.isSuccess").that(result1.data.isSuccess).isTrue()
      assertWithMessage("result1.post.content")
        .that(result1.data.getOrThrow().post?.content)
      ...
      assertWithMessage("results2[0].isSuccess").that(results2[0].data.isSuccess).isTrue()
      assertWithMessage("results2[1].isSuccess").that(results2[1].data.isSuccess).isTrue()
      assertWithMessage("results2[0].post.content")
        .that(results2[0].data.getOrThrow().post?.content)
        .isEqualTo(postContent1)
      assertWithMessage("results2[1].post.content")
        .that(results2[1].data.getOrThrow().post?.content)
