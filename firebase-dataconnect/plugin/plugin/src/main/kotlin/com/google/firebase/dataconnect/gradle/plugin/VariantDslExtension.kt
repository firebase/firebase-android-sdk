 ...
 *
 * Variant objects and custom extensions can be passed to multiple plugins that have registed a
 ...
 *
 * In this recipe, check [CustomSettings] for how this type is instantiated along extending other
 * DSL elements.
 */
abstract class VariantDslExtension
@Inject
constructor(
