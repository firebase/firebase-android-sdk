...
import com.google.firebase.appcheck.recaptcha.internal.DaggerProviderComponent;
...
/**
 * {@link ComponentRegistrar} for setting up FirebaseAppCheck reCAPTCHA's dependency
 * injections in Firebase Android Components.
 *
 * @hide
 */
@KeepForSdk
public class FirebaseAppCheckRecaptchaRegistrar implements ComponentRegistrar {
  private static final String LIBRARY_NAME = "fire-app-check-recaptcha";
