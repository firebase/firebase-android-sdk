...
/**
 * Client-side model of the ExchangeRecaptchaTokenRequest payload from the Firebase App
...
public class ExchangeRecaptchaTokenRequest {
  ...
  public ExchangeRecaptchaTokenRequest(@NonNull String recaptchaToken, boolean isLimitedUseToken) {
  ...
  public String toJsonString() throws JSONException {
    ...
    jsonObject.put(RECAPTCHA_TOKEN_KEY, recaptchaToken);
