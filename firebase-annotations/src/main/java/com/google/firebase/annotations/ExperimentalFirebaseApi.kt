...
/**
 * Marks declarations in a Firebase SDK that are **experimental**.
 *
 * A declaration annotated with [ExperimentalFirebaseApi] is "experimental": its signature and/or
 * semantics may change in backwards-incompatible ways at any time without notice, up to and
...
public annotation class ExperimentalFirebaseApi
