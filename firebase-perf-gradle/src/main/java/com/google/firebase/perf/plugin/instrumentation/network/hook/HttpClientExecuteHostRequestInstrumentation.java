...
/**
 * Instrumentation for Apache function "HttpClient#execute(HttpHost, HttpRequest)" which will be
 * replaced by Firebase Perf SDK function "FirebasePerfHttpClient#execute(HttpClient, HttpHost,
 * HttpRequest)".
 */
public class HttpClientExecuteHostRequestInstrumentation
    extends HttpClientExecuteBaseInstrumentation {

  public HttpClientExecuteHostRequestInstrumentation() {
    super(
        AsmString.METHOD_FIREBASE_PERF_HTTP_CLIENT_EXECUTE_WITH_HOST_REQUEST,
        AsmString.METHOD_DESC_FIREBASE_PERF_HTTP_CLIENT_EXECUTE_WITH_HOST_REQUEST);
  }
