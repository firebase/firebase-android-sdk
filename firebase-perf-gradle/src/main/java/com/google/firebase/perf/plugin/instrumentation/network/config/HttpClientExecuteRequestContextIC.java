...
/**
 * Gets config information for Apache function "HttpClient#execute(HttpUriRequest, HttpContext)"
...
public class HttpClientExecuteRequestContextIC extends NetworkObjectInstrumentationConfig {
  ...
  public HttpClientExecuteRequestContextIC() {
    super(
        new HttpClientExecuteRequestContextInstrumentation.Factory(),
        AsmString.CLASS_HTTP_CLIENT,
        AsmString.METHOD_HTTP_CLIENT_EXECUTE_WITH_REQUEST_CONTEXT,
        AsmString.METHOD_DESC_HTTP_CLIENT_EXECUTE_WITH_REQUEST_CONTEXT);
  }
}
