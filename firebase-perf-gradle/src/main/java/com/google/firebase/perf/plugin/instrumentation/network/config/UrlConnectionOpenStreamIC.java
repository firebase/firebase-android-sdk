...
/**
 * Gets config information for Oracle Java function "URL#openStream()}"that ASM will look at for
...
public class UrlConnectionOpenStreamIC extends NetworkObjectInstrumentationConfig {
  ...
  static {
    try {
      ...
      final Method openStreamMethod = URL.class.getDeclaredMethod(/* name */ "openStream");
  ...
  public UrlConnectionOpenStreamIC() {
    super(
        new UrlConnectionOpenStreamInstrumentation.Factory(), CLASS_NAME, METHOD_NAME, METHOD_DESC);
  }
}
