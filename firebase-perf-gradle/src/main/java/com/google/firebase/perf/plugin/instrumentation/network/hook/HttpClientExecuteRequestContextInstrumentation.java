...
/**
 * Instrumentation for Apache function "HttpClient#execute(HttpUriRequest, HttpContext)" which will
 * be replaced by Firebase Perf SDK function "FirebasePerfHttpClient#execute(HttpClient,
 * HttpUriRequest, HttpContext)".
 */
public class HttpClientExecuteRequestContextInstrumentation
    extends HttpClientExecuteBaseInstrumentation {

  public HttpClientExecuteRequestContextInstrumentation() {
    super(
        AsmString.METHOD_FIREBASE_PERF_HTTP_CLIENT_EXECUTE_WITH_REQUEST_CONTEXT,
        AsmString.METHOD_DESC_FIREBASE_PERF_HTTP_CLIENT_EXECUTE_WITH_REQUEST_CONTEXT);
  }
