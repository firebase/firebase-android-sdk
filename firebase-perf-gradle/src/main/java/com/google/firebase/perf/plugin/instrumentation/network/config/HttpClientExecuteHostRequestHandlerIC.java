 ...
 * ResponseHandler)" that ASM will look at for bytecode instrumentation.
 */
public class HttpClientExecuteHostRequestHandlerIC extends NetworkObjectInstrumentationConfig {
  ...
  public HttpClientExecuteHostRequestHandlerIC() {
    super(
        new HttpClientExecuteHostRequestHandlerInstrumentation.Factory(),
        AsmString.CLASS_HTTP_CLIENT,
        AsmString.METHOD_HTTP_CLIENT_EXECUTE_WITH_HOST_REQUEST_HANDLER,
        AsmString.METHOD_DESC_HTTP_CLIENT_EXECUTE_WITH_HOST_REQUEST_HANDLER);
  }
}
