...
public interface InstrumentationConfig {
  ...
  @Nullable
  List<AnnotatedMethodInstrumentationFactory> getAnnotatedMethodInstrumentationFactories(
      String classDesc);

  @Nullable
  NetworkObjectInstrumentationFactory getNetworkObjectInstrumentationFactory(
