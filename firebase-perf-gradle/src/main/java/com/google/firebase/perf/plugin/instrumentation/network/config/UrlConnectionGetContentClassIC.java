...
/**
 * Gets config information for Oracle Java function "URLConnection#getContent(Class[])" that ASM
...
public class UrlConnectionGetContentClassIC extends NetworkObjectInstrumentationConfig {
  ...
  static {
    try {
      ...
      final Method getContentMethod =
          URL.class.getDeclaredMethod(/* name */ "getContent", Class[].class);
  ...
  public UrlConnectionGetContentClassIC() {
    super(
        new UrlConnectionGetContentClassInstrumentation.Factory(),
        CLASS_NAME,
        METHOD_NAME,
        METHOD_DESC);
  }
