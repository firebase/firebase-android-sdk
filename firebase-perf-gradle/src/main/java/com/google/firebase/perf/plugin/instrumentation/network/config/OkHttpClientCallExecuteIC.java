...
/**
 * Gets config information for OkHttp function "Call.Factory#execute()" that ASM will look at for
...
public class OkHttpClientCallExecuteIC extends NetworkObjectInstrumentationConfig {
  ...
  public OkHttpClientCallExecuteIC() {
    super(
        new OkHttpClientCallExecuteInstrumentation.Factory(),
        AsmString.CLASS_OKHTTP300_CALL,
        AsmString.METHOD_OKHTTP300_CALL_EXECUTE,
        AsmString.METHOD_DESC_OKHTTP300_CALL_EXECUTE);
  }
}
