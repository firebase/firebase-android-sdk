...
/**
 * Gets config information for Apache function "HttpClient#execute(HttpHost, HttpRequest)" that ASM
 * will look at for bytecode instrumentation.
 */
public class HttpClientExecuteHostRequestIC extends NetworkObjectInstrumentationConfig {
  ...
  public HttpClientExecuteHostRequestIC() {
    super(
        new HttpClientExecuteHostRequestInstrumentation.Factory(),
        AsmString.CLASS_HTTP_CLIENT,
        AsmString.METHOD_HTTP_CLIENT_EXECUTE_WITH_HOST_REQUEST,
        AsmString.METHOD_DESC_HTTP_CLIENT_EXECUTE_WITH_HOST_REQUEST);
  }
}
