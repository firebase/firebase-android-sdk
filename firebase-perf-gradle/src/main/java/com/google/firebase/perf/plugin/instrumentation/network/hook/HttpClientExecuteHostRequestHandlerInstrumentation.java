 ...
 */
public class HttpClientExecuteHostRequestHandlerInstrumentation
    extends HttpClientExecuteBaseInstrumentation {

  public HttpClientExecuteHostRequestHandlerInstrumentation() {
    super(
        AsmString.METHOD_FIREBASE_PERF_HTTP_CLIENT_EXECUTE_WITH_HOST_REQUEST_HANDLER,
        AsmString.METHOD_DESC_FIREBASE_PERF_HTTP_CLIENT_EXECUTE_WITH_HOST_REQUEST_HANDLER);
  }
