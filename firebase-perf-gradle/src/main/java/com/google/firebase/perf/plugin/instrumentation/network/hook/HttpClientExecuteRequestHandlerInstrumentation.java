...
/**
 * Instrumentation for Apache function "HttpClient#execute(HttpUriRequest, ResponseHandler)" which
 * will be replaced by Firebase Perf SDK function "FirebasePerfHttpClient#execute(HttpClient,
 * HttpUriRequest, ResponseHandler)".
 */
public class HttpClientExecuteRequestHandlerInstrumentation
    extends HttpClientExecuteBaseInstrumentation {

  public HttpClientExecuteRequestHandlerInstrumentation() {
    super(
        AsmString.METHOD_FIREBASE_PERF_HTTP_CLIENT_EXECUTE_WITH_REQUEST_HANDLER,
        AsmString.METHOD_DESC_FIREBASE_PERF_HTTP_CLIENT_EXECUTE_WITH_REQUEST_HANDLER);
  }
