...
/**
 * Gets config information for Apache function "HttpClient#execute(HttpUriRequest, ResponseHandler,
 * HttpContext)" that ASM will look at for bytecode instrumentation.
 */
public class HttpClientExecuteRequestHandlerContextIC extends NetworkObjectInstrumentationConfig {
  ...
  public HttpClientExecuteRequestHandlerContextIC() {
    super(
        new HttpClientExecuteRequestHandlerContextInstrumentation.Factory(),
        AsmString.CLASS_HTTP_CLIENT,
        AsmString.METHOD_HTTP_CLIENT_EXECUTE_WITH_REQUEST_HANDLER_CONTEXT,
        AsmString.METHOD_DESC_HTTP_CLIENT_EXECUTE_WITH_REQUEST_HANDLER_CONTEXT);
  }
}
