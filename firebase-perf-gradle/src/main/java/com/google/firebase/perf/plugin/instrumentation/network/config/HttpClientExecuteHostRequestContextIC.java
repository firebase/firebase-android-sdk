...
public class HttpClientExecuteHostRequestContextIC extends NetworkObjectInstrumentationConfig {
  ...
  public HttpClientExecuteHostRequestContextIC() {
    super(
        new HttpClientExecuteHostRequestContextInstrumentation.Factory(),
        AsmString.CLASS_HTTP_CLIENT,
        AsmString.METHOD_HTTP_CLIENT_EXECUTE_WITH_HOST_REQUEST_CONTEXT,
        AsmString.METHOD_DESC_HTTP_CLIENT_EXECUTE_WITH_HOST_REQUEST_CONTEXT);
  }
}
