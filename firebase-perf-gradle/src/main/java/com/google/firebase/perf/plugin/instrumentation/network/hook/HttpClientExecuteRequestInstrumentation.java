...
/**
 * Instrumentation for Apache function "HttpClient#execute(HttpUriRequest)" which will be replaced
 * by Firebase Perf SDK function "FirebasePerfHttpClient#execute(HttpClient, HttpUriRequest)".
 */
public class HttpClientExecuteRequestInstrumentation extends HttpClientExecuteBaseInstrumentation {
  ...
  public HttpClientExecuteRequestInstrumentation() {
    super(
        AsmString.METHOD_FIREBASE_PERF_HTTP_CLIENT_EXECUTE_WITH_REQUEST,
        AsmString.METHOD_DESC_FIREBASE_PERF_HTTP_CLIENT_EXECUTE_WITH_REQUEST);
  }
