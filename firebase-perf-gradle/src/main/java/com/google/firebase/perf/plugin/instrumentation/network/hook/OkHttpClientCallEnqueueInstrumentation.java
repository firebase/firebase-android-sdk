...
/**
 * Instrumentation for OkHttp function "Call.Factory#enqueue(Callback)" which will be replaced by
 * Firebase Perf SDK function "FirebasePerfOkHttpClient#enqueue(Call, Callback)".
 */
public class OkHttpClientCallEnqueueInstrumentation extends BaseInstrumentation {

  public OkHttpClientCallEnqueueInstrumentation(
  ...
  public static class Factory implements NetworkObjectInstrumentationFactory {
    ...
    public NetworkObjectInstrumentation newObjectInstrumentation(
      ...
      return new OkHttpClientCallEnqueueInstrumentation(
          AsmString.CLASS_FIREBASE_PERF_OKHTTP300_CLIENT,
          AsmString.METHOD_FIREBASE_PERF_OKHTTP300_CALL_ENQUEUE_WITH_CALLBACK,
          AsmString.METHOD_DESC_FIREBASE_PERF_OKHTTP300_CALL_ENQUEUE_WITH_CALLBACK);
    }
  }
}
