...
/**
 * Instrumentation for Apache function "HttpClient#execute(HttpUriRequest, ResponseHandler,
 * HttpContext)" which will be replaced by Firebase Perf SDK function
 * "FirebasePerfHttpClient#execute(HttpClient, HttpUriRequest, ResponseHandler, HttpContext)".
 */
public class HttpClientExecuteRequestHandlerContextInstrumentation
    extends HttpClientExecuteBaseInstrumentation {

  public HttpClientExecuteRequestHandlerContextInstrumentation() {
    super(
        AsmString.METHOD_FIREBASE_PERF_HTTP_CLIENT_EXECUTE_WITH_REQUEST_HANDLER_CONTEXT,
        AsmString.METHOD_DESC_FIREBASE_PERF_HTTP_CLIENT_EXECUTE_WITH_REQUEST_HANDLER_CONTEXT);
  }
