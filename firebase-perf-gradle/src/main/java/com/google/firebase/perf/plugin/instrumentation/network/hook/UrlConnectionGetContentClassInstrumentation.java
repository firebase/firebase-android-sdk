...
/**
 * Instrumentation for Oracle Java function "URLConnection#getContent(Class[])" which will be
 * replaced by Firebase Perf SDK function "FirebasePerfUrlConnection#getContent(URL, Class[])".
 */
public class UrlConnectionGetContentClassInstrumentation extends BaseInstrumentation {

  public UrlConnectionGetContentClassInstrumentation(
  ...
  public static class Factory implements NetworkObjectInstrumentationFactory {
    ...
    public NetworkObjectInstrumentation newObjectInstrumentation(
      ...
      return new UrlConnectionGetContentClassInstrumentation(
          AsmString.CLASS_FIREBASE_PERF_URL_CONNECTION,
          AsmString.METHOD_FIREBASE_PERF_URL_CONNECTION_GET_CONTENT_WITH_URL_CLASS_ARRAY,
          AsmString.METHOD_DESC_FIREBASE_PERF_URL_CONNECTION_GET_CONTENT_WITH_URL_CLASS_ARRAY);
    }
  }
}
