...
/**
 * Instrumentation for Apache function "HttpClient#execute(HttpHost, HttpRequest, HttpContext)"
 * which will be replaced by Firebase Perf SDK function "FirebasePerfHttpClient#execute(HttpClient,
 * HttpHost, HttpRequest, HttpContext)".
 */
public class HttpClientExecuteHostRequestContextInstrumentation
    extends HttpClientExecuteBaseInstrumentation {

  public HttpClientExecuteHostRequestContextInstrumentation() {
    super(
        AsmString.METHOD_FIREBASE_PERF_HTTP_CLIENT_EXECUTE_WITH_HOST_REQUEST_CONTEXT,
        AsmString.METHOD_DESC_FIREBASE_PERF_HTTP_CLIENT_EXECUTE_WITH_HOST_REQUEST_CONTEXT);
  }
