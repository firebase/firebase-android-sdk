...
/** The instrumentation config class for processing firebase timer annotations. */
public class FirebaseTimerAnnotationConfig extends AnnotatedMethodInstrumentationConfig {
  ...
  public FirebaseTimerAnnotationConfig() {
    super(
        new FirebaseTimerAnnotationProcessor.Factory(),
        AsmString.ANNOTATION_FIREBASE_PERF_ADD_TRACE);
  }
}
