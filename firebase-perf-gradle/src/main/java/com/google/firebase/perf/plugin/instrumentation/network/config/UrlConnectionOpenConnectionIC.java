...
/**
 * Gets config information for Oracle Java function "URL#openConnection()" that ASM will look at for
...
public class UrlConnectionOpenConnectionIC extends NetworkObjectInstrumentationConfig {
  ...
  static {
    try {
      ...
      final Method openConnectionMethod = URL.class.getDeclaredMethod(/* name */ "openConnection");
