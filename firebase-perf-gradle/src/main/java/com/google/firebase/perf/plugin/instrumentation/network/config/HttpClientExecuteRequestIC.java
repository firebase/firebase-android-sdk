...
/**
 * Gets config information for Apache function "HttpClient#execute(HttpUriRequest)" that ASM will
 * look at for bytecode instrumentation.
 */
public class HttpClientExecuteRequestIC extends NetworkObjectInstrumentationConfig {

  public HttpClientExecuteRequestIC() {
    super(
        new HttpClientExecuteRequestInstrumentation.Factory(),
        AsmString.CLASS_HTTP_CLIENT,
        AsmString.METHOD_HTTP_CLIENT_EXECUTE_WITH_REQUEST,
        AsmString.METHOD_DESC_HTTP_CLIENT_EXECUTE_WITH_REQUEST);
  }
}
