...
/**
 * Instrumentation for OkHttp function "Call.Factory#execute()" which will be replaced by Firebase
 * Perf SDK function "FirebasePerfOkHttpClient#execute(Call)".
 */
public class OkHttpClientCallExecuteInstrumentation extends BaseInstrumentation {

  public OkHttpClientCallExecuteInstrumentation(
  ...
  public static class Factory implements NetworkObjectInstrumentationFactory {
    ...
    public NetworkObjectInstrumentation newObjectInstrumentation(
      ...
      return new OkHttpClientCallExecuteInstrumentation(
          AsmString.CLASS_FIREBASE_PERF_OKHTTP300_CLIENT,
          AsmString.METHOD_FIREBASE_PERF_OKHTTP300_CALL_EXECUTE,
          AsmString.METHOD_DESC_FIREBASE_PERF_OKHTTP300_CALL_EXECUTE);
    }
  }
}
