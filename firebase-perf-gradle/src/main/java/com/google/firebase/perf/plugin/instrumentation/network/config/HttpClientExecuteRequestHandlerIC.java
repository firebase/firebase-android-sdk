 ...
 * that ASM will look at for bytecode instrumentation.
 */
public class HttpClientExecuteRequestHandlerIC extends NetworkObjectInstrumentationConfig {
  ...
  public HttpClientExecuteRequestHandlerIC() {
    super(
        new HttpClientExecuteRequestHandlerInstrumentation.Factory(),
        AsmString.CLASS_HTTP_CLIENT,
        AsmString.METHOD_HTTP_CLIENT_EXECUTE_WITH_REQUEST_HANDLER,
        AsmString.METHOD_DESC_HTTP_CLIENT_EXECUTE_WITH_REQUEST_HANDLER);
  }
}
