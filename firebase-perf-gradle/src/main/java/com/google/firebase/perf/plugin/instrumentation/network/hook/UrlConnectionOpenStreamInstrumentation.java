...
/**
 * Instrumentation for Oracle Java function "URL#openStream()" which will be replaced by Firebase
 * Perf SDK function "FirebasePerfUrlConnection#openStream(URL)".
 */
public class UrlConnectionOpenStreamInstrumentation extends BaseInstrumentation {

  public UrlConnectionOpenStreamInstrumentation(
  ...
  public static class Factory implements NetworkObjectInstrumentationFactory {
    ...
    public NetworkObjectInstrumentation newObjectInstrumentation(
      ...
      return new UrlConnectionOpenStreamInstrumentation(
          AsmString.CLASS_FIREBASE_PERF_URL_CONNECTION,
          AsmString.METHOD_FIREBASE_PERF_URL_CONNECTION_OPEN_STREAM_WITH_URL,
          AsmString.METHOD_DESC_FIREBASE_PERF_URL_CONNECTION_OPEN_STREAM_WITH_URL);
    }
  }
}
