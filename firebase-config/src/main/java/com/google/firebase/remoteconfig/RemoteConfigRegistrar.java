...
public class RemoteConfigRegistrar implements ComponentRegistrar {
  ...
  public List<Component<?>> getComponents() {
    Qualified<ScheduledExecutorService> scheduledExecutorService = Qualified.qualified(Blocking.class, ScheduledExecutorService.class);
    return Arrays.asList(
        Component.builder(RemoteConfigComponent.class)
            .name(LIBRARY_NAME)
            .add(Dependency.required(Context.class))
            .add(Dependency.required(scheduledExecutorService))
            ...
            .factory(
                container ->
                    new RemoteConfigComponent(
                        ...
                        container.get(scheduledExecutorService),
