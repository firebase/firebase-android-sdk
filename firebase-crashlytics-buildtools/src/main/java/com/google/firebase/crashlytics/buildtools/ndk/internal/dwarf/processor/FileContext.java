...
/**
 * Represents contextual data applicable for the entire file being processed.
 */
public class FileContext {
  ...
  public FileContext(
      DebugElfSectionHeaders debugSectionHeaders, ReferenceBytesConverter referenceBytesConverter) {
    this.debugSectionHeaders = debugSectionHeaders;
