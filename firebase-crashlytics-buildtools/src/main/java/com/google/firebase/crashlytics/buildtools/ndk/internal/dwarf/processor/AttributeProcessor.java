...
/**
 * Interface for processing attributes read from a DWARF Debugging Information Entry.
 * See DWARF 4 spec section 2.2 for more information.
 */
public interface AttributeProcessor<T> {
  void processAttribute(DWAttribute attribute, DWForm form, byte[] value);

  void processAttribute(DWAttribute attribute, long value);

  void processAttribute(DWAttribute attribute, String value);
