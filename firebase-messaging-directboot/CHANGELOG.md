...
- [changed] Updated `minSdkVersion` to 19 to match [messaging_longer] `minSdkVersion`.
- [changed] Updated `FirebaseMessagingDirectBootReceiver` to match [messaging_longer]
...
- [feature] The Firebase Cloud Messaging Direct Boot SDK is now available and supports receiving FCM
