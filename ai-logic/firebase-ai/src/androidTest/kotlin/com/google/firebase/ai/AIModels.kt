...
public class AIModels {
  ...
  public companion object {
    ...
    public val vertexAIFlashModel: GenerativeModel by lazy {
      getGenerativeModel(GenerativeBackend.enterprise("global"), "gemini-3.5-flash")
    }
    public val vertexAIFlashLiteModel: GenerativeModel by lazy {
      getGenerativeModel(GenerativeBackend.enterprise("global"), "gemini-3.1-flash-lite")
    }
    ...
    public val agentPlatformTemplateModel: TemplateGenerativeModel by lazy {
      FirebaseAI.getInstance(app(), GenerativeBackend.enterprise()).templateGenerativeModel()
    }
    ...
    public fun getGenerativeModels(
      ...
      return listOf(
        getGenerativeModel(GenerativeBackend.enterprise("global"), modelName, config),
    ...
    public fun getVertexLiveModel(
      ...
      return FirebaseAI.getInstance(app(), GenerativeBackend.enterprise())
        .liveModel(
