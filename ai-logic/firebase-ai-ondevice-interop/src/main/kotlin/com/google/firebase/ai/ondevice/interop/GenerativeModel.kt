...
public interface GenerativeModel {
  ...
  /**
   * Generates new structured content from the input [GenerateContentRequest] given to the model as
   * a prompt, using the provided [shadowClass] for schema definition.
   *
   * @param request The input given to the model as a prompt.
   * @param shadowClass The shadow class (e.g. `<ClassName>MlKit`) to be used for structured
   * generation.
   * @throws [FirebaseAIOnDeviceNotAvailableException] if model is not available.
   * @return The content generated by the model.
   */
  public suspend fun generateObject(
