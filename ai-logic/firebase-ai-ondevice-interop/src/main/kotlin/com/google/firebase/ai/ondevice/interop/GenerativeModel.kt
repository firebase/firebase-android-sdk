...
public interface GenerativeModel {
  ...
  /**
   * Generates structured object content from the input [GenerateContentRequest] constrained by
   * [schema].
   *
   * @param request The input given to the model as a prompt.
   * @param schema The target schema encapsulation.
   * @throws [FirebaseAIOnDeviceNotAvailableException] if model is not available.
  ...
  public suspend fun <T : Any> generateObject(
    ...
    throw UnsupportedOperationException("generateObject is not implemented by this model")
  }
