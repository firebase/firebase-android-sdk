...
import com.google.firebase.appdistribution.gradle.FirebaseAppDistribution.removeTesters
import org.gradle.api.tasks.TaskAction
import org.gradle.work.DisableCachingByDefault

/** Task for removing Firebase App Distribution testers, in bulk. */
@DisableCachingByDefault(because = "Remote server operation")
abstract class RemoveTestersTask : TesterManagementTask() {
  @TaskAction
  fun removeTesters() {
    try {
      removeTesters(options)
