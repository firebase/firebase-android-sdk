...
public class UploadTest {
  ...
  //
  //  /**
  //   * This test will replicate uploadChunk() returning 500's and test to make sure the retries
  // are
  ...
  //
  //    MockConnectionFactory factory = NetworkLayerMock.ensureNetworkMock("fileUploadWith500",
  // true);
  //
  ...
  //
  //    MockConnectionFactory factory = NetworkLayerMock.ensureNetworkMock("smallTextUpload2",
  // true);
  //
  ...
  //
  //    MockConnectionFactory factory = NetworkLayerMock.ensureNetworkMock("uploadWithUnicode",
  // true);
  ...
  //
  //    MockConnectionFactory factory = NetworkLayerMock.ensureNetworkMock("adaptiveChunking",
  // false);
  //
  ...
  //
  //    MockConnectionFactory factory = NetworkLayerMock.ensureNetworkMock("fileUploadRecovery",
  // false);
  //
  ...
  //
  //    factory.verifyOldMock();
  //    TestUtil.verifyTaskStateChanges("streamUploadWithInterruptions",
