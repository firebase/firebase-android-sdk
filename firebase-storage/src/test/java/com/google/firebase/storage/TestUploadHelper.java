...
public class TestUploadHelper {
              ...
              .addOnSuccessListener(
                  uri ->
                      FirebaseStorage.getInstance()
                          ...
                          .addOnSuccessListener(
                              bytes1 -> {
                                Assert.assertEquals(foo, new String(bytes1));
  ...
  public static Task<StringBuilder> smallTextUpload() {
    ...
    Assert.assertTrue(storage.getActiveUploadTasks().isEmpty());
    final UploadTask task = storage.putBytes(bytes, metadata);
    Assert.assertEquals(1, storage.getActiveUploadTasks().size());
  ...
  public static Task<StringBuilder> fileUpload(final Uri sourcefile, final String filename)
    ...
    return fileUploadImpl(
        builder, sourcefile, "gs://project-5516366556574091405.appspot.com/" + filename);
  }
  ...
  private static Task<StringBuilder> fileUploadImpl(
    ...
    Assert.assertFalse(
        StorageTaskManager.getInstance().getUploadTasksUnder(storage.getParent()).isEmpty());
    Assert.assertFalse(storage.getActiveUploadTasks().isEmpty());
  ...
  public static Task<StringBuilder> streamUploadWithInterruptions() {
    ...
    StorageReference storage =
        FirebaseStorage.getInstance()
            .getReferenceFromUrl("gs://project-5516366556574091405.appspot.com/testdata.dat");
  ...
  public static Task<StringBuilder> byteUploadCancel() {
    ...
    final StorageReference storage =
        FirebaseStorage.getInstance()
            .getReferenceFromUrl("gs://project-5516366556574091405.appspot.com/foo.txt");
  ...
  public static Task<StringBuilder> adaptiveChunking() {
    ...
    final StorageReference storage =
        FirebaseStorage.getInstance()
            .getReferenceFromUrl("gs://project-5516366556574091405.appspot.com/adaptive.dat");
        ...
        storage.putStream(
            new InputStream() {
              ...
              public int read(byte[] buffer, int offset, int length) {
                Assert.assertEquals((int) expectedReadSize.remove(0), length);
    ...
    attachListeners(
        ...
        completedTask -> {
          ...
          Log.i(TAG, statusMessage);
          builder.append(statusMessage);
          Assert.assertTrue(expectedReadSize.isEmpty());
        });
  ...
  static String uploadTaskStatetoString(UploadTask.TaskSnapshot task) {
