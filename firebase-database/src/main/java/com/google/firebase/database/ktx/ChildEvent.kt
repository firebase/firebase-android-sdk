 ...
 */
@Deprecated(
  "com.google.firebase.databasektx. has been deprecated. Use `com.google.firebase.database` instead.",
  ReplaceWith(
    expression = "",
    imports = ["com.google.firebase.Firebase", "com.google.firebase.database"]
  )
)
